...
["broadcast"] = false, -- ./compiler/lua54.lpt:105
["filter"] = false -- ./compiler/lua54.lpt:105
} -- ./compiler/lua54.lpt:105
local function addBroadcast() -- ./compiler/lua54.lpt:106
if not libraries["broadcast"] then -- ./compiler/lua54.lpt:107
addLua((" -- ./compiler/lua54.lpt:108\
local function %sbroadcast(func, t, use_kv) -- ./compiler/lua54.lpt:109\
    local new = {} -- ./compiler/lua54.lpt:110\
    for k, v in pairs(t) do -- ./compiler/lua54.lpt:111\
        local pair -- ./compiler/lua54.lpt:112\
        if use_kv then -- ./compiler/lua54.lpt:113\
            pair = { func(k, v) } -- ./compiler/lua54.lpt:114\
        else -- ./compiler/lua54.lpt:115\
            pair = { func(v) } -- ./compiler/lua54.lpt:116\
        end -- ./compiler/lua54.lpt:117\
        local len = #pair -- ./compiler/lua54.lpt:118\
        if len == 1 then -- ./compiler/lua54.lpt:119\
            new[k] = pair[1] -- ./compiler/lua54.lpt:120\
        elseif len ~= 0 then -- ./compiler/lua54.lpt:121\
            new[pair[1]] = pair[2] -- ./compiler/lua54.lpt:122\
        end -- ./compiler/lua54.lpt:123\
    end -- ./compiler/lua54.lpt:124\
    if next(new) ~= nil then -- ./compiler/lua54.lpt:125\
        return new -- ./compiler/lua54.lpt:126\
    end -- ./compiler/lua54.lpt:127\
end -- ./compiler/lua54.lpt:128\
"):format(options["variablePrefix"])) -- ./compiler/lua54.lpt:129
libraries["broadcast"] = true -- ./compiler/lua54.lpt:130
end -- ./compiler/lua54.lpt:130
end -- ./compiler/lua54.lpt:130
local function addFilter() -- ./compiler/lua54.lpt:133
if not libraries["filter"] then -- ./compiler/lua54.lpt:134
addLua((" -- ./compiler/lua54.lpt:135\
local function %sfilter(predicate, t, use_kv) -- ./compiler/lua54.lpt:136\
    local new = {} -- ./compiler/lua54.lpt:137\
    local i = 1 -- ./compiler/lua54.lpt:138\
    for k, v in pairs(t) do -- ./compiler/lua54.lpt:139\
        local result -- ./compiler/lua54.lpt:140\
        if use_kv then -- ./compiler/lua54.lpt:141\
            result = predicate(k, v) -- ./compiler/lua54.lpt:142\
        else -- ./compiler/lua54.lpt:143\
            result = predicate(v) -- ./compiler/lua54.lpt:144\
        end -- ./compiler/lua54.lpt:145\
        if result then -- ./compiler/lua54.lpt:146\
            if type(k) == 'number' then -- ./compiler/lua54.lpt:147\
                new[i] = v -- ./compiler/lua54.lpt:148\
                i = i + 1 -- ./compiler/lua54.lpt:149\
            else -- ./compiler/lua54.lpt:150\
                new[k] = v -- ./compiler/lua54.lpt:151\
            end -- ./compiler/lua54.lpt:152\
        end -- ./compiler/lua54.lpt:153\
    end -- ./compiler/lua54.lpt:154\
    return new -- ./compiler/lua54.lpt:155\
end -- ./compiler/lua54.lpt:156\
"):format(options["variablePrefix"])) -- ./compiler/lua54.lpt:157
libraries["filter"] = true -- ./compiler/lua54.lpt:158
end -- ./compiler/lua54.lpt:158
end -- ./compiler/lua54.lpt:158
local required = {} -- ./compiler/lua54.lpt:164
local requireStr = "" -- ./compiler/lua54.lpt:165
local function addRequire(mod, name, field) -- ./compiler/lua54.lpt:167
local req = ("require(%q)%s"):format(mod, field and "." .. field or "") -- ./compiler/lua54.lpt:168
if not required[req] then -- ./compiler/lua54.lpt:169
requireStr = requireStr .. (("local %s = %s%s"):format(var(name), req, options["newline"])) -- ./compiler/lua54.lpt:170
required[req] = true -- ./compiler/lua54.lpt:171
end -- ./compiler/lua54.lpt:171
end -- ./compiler/lua54.lpt:171
local loop = { -- ./compiler/lua54.lpt:177
"While", -- ./compiler/lua54.lpt:177
"Repeat", -- ./compiler/lua54.lpt:177
"Fornum", -- ./compiler/lua54.lpt:177
"Forin", -- ./compiler/lua54.lpt:177
"WhileExpr", -- ./compiler/lua54.lpt:177
"RepeatExpr", -- ./compiler/lua54.lpt:177
"FornumExpr", -- ./compiler/lua54.lpt:177
"ForinExpr" -- ./compiler/lua54.lpt:177
} -- ./compiler/lua54.lpt:177
local func = { -- ./compiler/lua54.lpt:178
"Function", -- ./compiler/lua54.lpt:178
"TableCompr", -- ./compiler/lua54.lpt:178
"DoExpr", -- ./compiler/lua54.lpt:178
"WhileExpr", -- ./compiler/lua54.lpt:178
"RepeatExpr", -- ./compiler/lua54.lpt:178
"IfExpr", -- ./compiler/lua54.lpt:178
"FornumExpr", -- ./compiler/lua54.lpt:178
"ForinExpr" -- ./compiler/lua54.lpt:178
} -- ./compiler/lua54.lpt:178
local function any(list, tags, nofollow) -- ./compiler/lua54.lpt:182
if nofollow == nil then nofollow = {} end -- ./compiler/lua54.lpt:182
local tagsCheck = {} -- ./compiler/lua54.lpt:183
for _, tag in ipairs(tags) do -- ./compiler/lua54.lpt:184
tagsCheck[tag] = true -- ./compiler/lua54.lpt:185
end -- ./compiler/lua54.lpt:185
local nofollowCheck = {} -- ./compiler/lua54.lpt:187
for _, tag in ipairs(nofollow) do -- ./compiler/lua54.lpt:188
nofollowCheck[tag] = true -- ./compiler/lua54.lpt:189
end -- ./compiler/lua54.lpt:189
for _, node in ipairs(list) do -- ./compiler/lua54.lpt:191
if type(node) == "table" then -- ./compiler/lua54.lpt:192
if tagsCheck[node["tag"]] then -- ./compiler/lua54.lpt:193
return node -- ./compiler/lua54.lpt:194
end -- ./compiler/lua54.lpt:194
if not nofollowCheck[node["tag"]] then -- ./compiler/lua54.lpt:196
local r = any(node, tags, nofollow) -- ./compiler/lua54.lpt:197
if r then -- ./compiler/lua54.lpt:198
return r -- ./compiler/lua54.lpt:198
end -- ./compiler/lua54.lpt:198
end -- ./compiler/lua54.lpt:198
end -- ./compiler/lua54.lpt:198
end -- ./compiler/lua54.lpt:198
return nil -- ./compiler/lua54.lpt:202
end -- ./compiler/lua54.lpt:202
local function search(list, tags, nofollow) -- ./compiler/lua54.lpt:207
if nofollow == nil then nofollow = {} end -- ./compiler/lua54.lpt:207
local tagsCheck = {} -- ./compiler/lua54.lpt:208
for _, tag in ipairs(tags) do -- ./compiler/lua54.lpt:209
tagsCheck[tag] = true -- ./compiler/lua54.lpt:210
end -- ./compiler/lua54.lpt:210
local nofollowCheck = {} -- ./compiler/lua54.lpt:212
for _, tag in ipairs(nofollow) do -- ./compiler/lua54.lpt:213
nofollowCheck[tag] = true -- ./compiler/lua54.lpt:214
end -- ./compiler/lua54.lpt:214
local found = {} -- ./compiler/lua54.lpt:216
for _, node in ipairs(list) do -- ./compiler/lua54.lpt:217
if type(node) == "table" then -- ./compiler/lua54.lpt:218
if not nofollowCheck[node["tag"]] then -- ./compiler/lua54.lpt:219
for _, n in ipairs(search(node, tags, nofollow)) do -- ./compiler/lua54.lpt:220
table["insert"](found, n) -- ./compiler/lua54.lpt:221
end -- ./compiler/lua54.lpt:221
end -- ./compiler/lua54.lpt:221
if tagsCheck[node["tag"]] then -- ./compiler/lua54.lpt:224
table["insert"](found, node) -- ./compiler/lua54.lpt:225
end -- ./compiler/lua54.lpt:225
end -- ./compiler/lua54.lpt:225
end -- ./compiler/lua54.lpt:225
return found -- ./compiler/lua54.lpt:229
end -- ./compiler/lua54.lpt:229
local function all(list, tags) -- ./compiler/lua54.lpt:233
for _, node in ipairs(list) do -- ./compiler/lua54.lpt:234
local ok = false -- ./compiler/lua54.lpt:235
for _, tag in ipairs(tags) do -- ./compiler/lua54.lpt:236
if node["tag"] == tag then -- ./compiler/lua54.lpt:237
ok = true -- ./compiler/lua54.lpt:238
break -- ./compiler/lua54.lpt:239
end -- ./compiler/lua54.lpt:239
end -- ./compiler/lua54.lpt:239
if not ok then -- ./compiler/lua54.lpt:242
return false -- ./compiler/lua54.lpt:243
end -- ./compiler/lua54.lpt:243
end -- ./compiler/lua54.lpt:243
return true -- ./compiler/lua54.lpt:246
end -- ./compiler/lua54.lpt:246
local tags -- ./compiler/lua54.lpt:251
local function lua(ast, forceTag, ...) -- ./compiler/lua54.lpt:253
if options["mapLines"] and ast["pos"] then -- ./compiler/lua54.lpt:254
lastInputPos = ast["pos"] -- ./compiler/lua54.lpt:255
end -- ./compiler/lua54.lpt:255
return tags[forceTag or ast["tag"]](ast, ...) -- ./compiler/lua54.lpt:257
end -- ./compiler/lua54.lpt:257
local UNPACK = function(list, i, j) -- ./compiler/lua54.lpt:262
return "table.unpack(" .. list .. (i and (", " .. i .. (j and (", " .. j) or "")) or "") .. ")" -- ./compiler/lua54.lpt:263
end -- ./compiler/lua54.lpt:263
local APPEND = function(t, toAppend) -- ./compiler/lua54.lpt:265
return "do" .. indent() .. "local " .. var("a") .. " = table.pack(" .. toAppend .. ")" .. newline() .. "table.move(" .. var("a") .. ", 1, " .. var("a") .. ".n, #" .. t .. "+1, " .. t .. ")" .. unindent() .. "end" -- ./compiler/lua54.lpt:266
end -- ./compiler/lua54.lpt:266
local CONTINUE_START = function() -- ./compiler/lua54.lpt:268
return "do" .. indent() -- ./compiler/lua54.lpt:269
end -- ./compiler/lua54.lpt:269
local CONTINUE_STOP = function() -- ./compiler/lua54.lpt:271
return unindent() .. "end" .. newline() .. "::" .. var("continue") .. "::" -- ./compiler/lua54.lpt:272
end -- ./compiler/lua54.lpt:272
...
local BROADCAST = function(t, use_kv) -- ./compiler/lua54.lpt:313
addBroadcast() -- ./compiler/lua54.lpt:314
return table["concat"]({ -- ./compiler/lua54.lpt:315
options["variablePrefix"], -- ./compiler/lua54.lpt:315
"broadcast(", -- ./compiler/lua54.lpt:315
lua(t[1]), -- ./compiler/lua54.lpt:315
",", -- ./compiler/lua54.lpt:315
lua(t[2]), -- ./compiler/lua54.lpt:315
(use_kv and ", true") or "", -- ./compiler/lua54.lpt:315
")" -- ./compiler/lua54.lpt:315
}) -- ./compiler/lua54.lpt:315
end -- ./compiler/lua54.lpt:315
local FILTER = function(t, use_kv) -- ./compiler/lua54.lpt:317
addFilter() -- ./compiler/lua54.lpt:318
return table["concat"]({ -- ./compiler/lua54.lpt:319
options["variablePrefix"], -- ./compiler/lua54.lpt:319
"filter(", -- ./compiler/lua54.lpt:319
lua(t[1]), -- ./compiler/lua54.lpt:319
",", -- ./compiler/lua54.lpt:319
lua(t[2]), -- ./compiler/lua54.lpt:319
(use_kv and ", true") or "", -- ./compiler/lua54.lpt:319
")" -- ./compiler/lua54.lpt:319
}) -- ./compiler/lua54.lpt:319
end -- ./compiler/lua54.lpt:319
tags = setmetatable({ -- ./compiler/lua54.lpt:324
["Block"] = function(t) -- ./compiler/lua54.lpt:327
local hasPush = peek("push") == nil and any(t, { "Push" }, func) -- ./compiler/lua54.lpt:328
if hasPush and hasPush == t[# t] then -- ./compiler/lua54.lpt:329
hasPush["tag"] = "Return" -- ./compiler/lua54.lpt:330
hasPush = false -- ./compiler/lua54.lpt:331
end -- ./compiler/lua54.lpt:331
local r = push("scope", {}) -- ./compiler/lua54.lpt:333
if hasPush then -- ./compiler/lua54.lpt:334
r = r .. (push("push", var("push")) .. "local " .. var("push") .. " = {}" .. newline()) -- ./compiler/lua54.lpt:335
end -- ./compiler/lua54.lpt:335
for i = 1, # t - 1, 1 do -- ./compiler/lua54.lpt:337
r = r .. (lua(t[i]) .. newline()) -- ./compiler/lua54.lpt:338
end -- ./compiler/lua54.lpt:338
if t[# t] then -- ./compiler/lua54.lpt:340
r = r .. (lua(t[# t])) -- ./compiler/lua54.lpt:341
end -- ./compiler/lua54.lpt:341
if hasPush and (t[# t] and t[# t]["tag"] ~= "Return") then -- ./compiler/lua54.lpt:343
r = r .. (newline() .. "return " .. UNPACK(var("push")) .. pop("push")) -- ./compiler/lua54.lpt:344
end -- ./compiler/lua54.lpt:344
return r .. pop("scope") -- ./compiler/lua54.lpt:346
end, -- ./compiler/lua54.lpt:346
["Do"] = function(t) -- ./compiler/lua54.lpt:352
return "do" .. indent() .. lua(t, "Block") .. unindent() .. "end" -- ./compiler/lua54.lpt:353
end, -- ./compiler/lua54.lpt:353
["Set"] = function(t) -- ./compiler/lua54.lpt:356
local expr = t[# t] -- ./compiler/lua54.lpt:358
local vars, values = {}, {} -- ./compiler/lua54.lpt:359
local destructuringVars, destructuringValues = {}, {} -- ./compiler/lua54.lpt:360
for i, n in ipairs(t[1]) do -- ./compiler/lua54.lpt:361
if n["tag"] == "DestructuringId" then -- ./compiler/lua54.lpt:362
table["insert"](destructuringVars, n) -- ./compiler/lua54.lpt:363
table["insert"](destructuringValues, expr[i]) -- ./compiler/lua54.lpt:364
else -- ./compiler/lua54.lpt:364
table["insert"](vars, n) -- ./compiler/lua54.lpt:366
table["insert"](values, expr[i]) -- ./compiler/lua54.lpt:367
end -- ./compiler/lua54.lpt:367
end -- ./compiler/lua54.lpt:367
if # t == 2 or # t == 3 then -- ./compiler/lua54.lpt:371
local r = "" -- ./compiler/lua54.lpt:372
if # vars > 0 then -- ./compiler/lua54.lpt:373
r = lua(vars, "_lhs") .. " = " .. lua(values, "_lhs") -- ./compiler/lua54.lpt:374
end -- ./compiler/lua54.lpt:374
if # destructuringVars > 0 then -- ./compiler/lua54.lpt:376
local destructured = {} -- ./compiler/lua54.lpt:377
r = r .. ("local " .. push("destructuring", destructured) .. lua(destructuringVars, "_lhs") .. pop("destructuring") .. " = " .. lua(destructuringValues, "_lhs")) -- ./compiler/lua54.lpt:378
return r .. DESTRUCTURING_ASSIGN(destructured, nil, true) -- ./compiler/lua54.lpt:379
end -- ./compiler/lua54.lpt:379
return r -- ./compiler/lua54.lpt:381
elseif # t == 4 then -- ./compiler/lua54.lpt:382
if t[3] == "=" then -- ./compiler/lua54.lpt:383
local r = "" -- ./compiler/lua54.lpt:384
if # vars > 0 then -- ./compiler/lua54.lpt:385
r = r .. (lua(vars, "_lhs") .. " = " .. lua({ -- ./compiler/lua54.lpt:386
t[2], -- ./compiler/lua54.lpt:386
vars[1], -- ./compiler/lua54.lpt:386
{ -- ./compiler/lua54.lpt:386
["tag"] = "Paren", -- ./compiler/lua54.lpt:386
values[1] -- ./compiler/lua54.lpt:386
} -- ./compiler/lua54.lpt:386
}, "Op")) -- ./compiler/lua54.lpt:386
for i = 2, math["min"](# t[4], # vars), 1 do -- ./compiler/lua54.lpt:387
r = r .. (", " .. lua({ -- ./compiler/lua54.lpt:388
t[2], -- ./compiler/lua54.lpt:388
vars[i], -- ./compiler/lua54.lpt:388
{ -- ./compiler/lua54.lpt:388
["tag"] = "Paren", -- ./compiler/lua54.lpt:388
values[i] -- ./compiler/lua54.lpt:388
} -- ./compiler/lua54.lpt:388
}, "Op")) -- ./compiler/lua54.lpt:388
end -- ./compiler/lua54.lpt:388
end -- ./compiler/lua54.lpt:388
if # destructuringVars > 0 then -- ./compiler/lua54.lpt:391
local destructured = { ["rightOp"] = t[2] } -- ./compiler/lua54.lpt:392
r = r .. ("local " .. push("destructuring", destructured) .. lua(destructuringVars, "_lhs") .. pop("destructuring") .. " = " .. lua(destructuringValues, "_lhs")) -- ./compiler/lua54.lpt:393
return r .. DESTRUCTURING_ASSIGN(destructured, nil, true) -- ./compiler/lua54.lpt:394
end -- ./compiler/lua54.lpt:394
return r -- ./compiler/lua54.lpt:396
else -- ./compiler/lua54.lpt:396
local r = "" -- ./compiler/lua54.lpt:398
if # vars > 0 then -- ./compiler/lua54.lpt:399
r = r .. (lua(vars, "_lhs") .. " = " .. lua({ -- ./compiler/lua54.lpt:400
t[3], -- ./compiler/lua54.lpt:400
{ -- ./compiler/lua54.lpt:400
["tag"] = "Paren", -- ./compiler/lua54.lpt:400
values[1] -- ./compiler/lua54.lpt:400
}, -- ./compiler/lua54.lpt:400
vars[1] -- ./compiler/lua54.lpt:400
}, "Op")) -- ./compiler/lua54.lpt:400
for i = 2, math["min"](# t[4], # t[1]), 1 do -- ./compiler/lua54.lpt:401
r = r .. (", " .. lua({ -- ./compiler/lua54.lpt:402
t[3], -- ./compiler/lua54.lpt:402
{ -- ./compiler/lua54.lpt:402
["tag"] = "Paren", -- ./compiler/lua54.lpt:402
values[i] -- ./compiler/lua54.lpt:402
}, -- ./compiler/lua54.lpt:402
vars[i] -- ./compiler/lua54.lpt:402
}, "Op")) -- ./compiler/lua54.lpt:402
end -- ./compiler/lua54.lpt:402
end -- ./compiler/lua54.lpt:402
if # destructuringVars > 0 then -- ./compiler/lua54.lpt:405
local destructured = { ["leftOp"] = t[3] } -- ./compiler/lua54.lpt:406
r = r .. ("local " .. push("destructuring", destructured) .. lua(destructuringVars, "_lhs") .. pop("destructuring") .. " = " .. lua(destructuringValues, "_lhs")) -- ./compiler/lua54.lpt:407
return r .. DESTRUCTURING_ASSIGN(destructured, nil, true) -- ./compiler/lua54.lpt:408
end -- ./compiler/lua54.lpt:408
return r -- ./compiler/lua54.lpt:410
end -- ./compiler/lua54.lpt:410
else -- ./compiler/lua54.lpt:410
local r = "" -- ./compiler/lua54.lpt:413
if # vars > 0 then -- ./compiler/lua54.lpt:414
r = r .. (lua(vars, "_lhs") .. " = " .. lua({ -- ./compiler/lua54.lpt:415
t[2], -- ./compiler/lua54.lpt:415
vars[1], -- ./compiler/lua54.lpt:415
{ -- ./compiler/lua54.lpt:415
["tag"] = "Op", -- ./compiler/lua54.lpt:415
t[4], -- ./compiler/lua54.lpt:415
{ -- ./compiler/lua54.lpt:415
["tag"] = "Paren", -- ./compiler/lua54.lpt:415
values[1] -- ./compiler/lua54.lpt:415
}, -- ./compiler/lua54.lpt:415
vars[1] -- ./compiler/lua54.lpt:415
} -- ./compiler/lua54.lpt:415
}, "Op")) -- ./compiler/lua54.lpt:415
for i = 2, math["min"](# t[5], # t[1]), 1 do -- ./compiler/lua54.lpt:416
r = r .. (", " .. lua({ -- ./compiler/lua54.lpt:417
t[2], -- ./compiler/lua54.lpt:417
vars[i], -- ./compiler/lua54.lpt:417
{ -- ./compiler/lua54.lpt:417
["tag"] = "Op", -- ./compiler/lua54.lpt:417
t[4], -- ./compiler/lua54.lpt:417
{ -- ./compiler/lua54.lpt:417
["tag"] = "Paren", -- ./compiler/lua54.lpt:417
values[i] -- ./compiler/lua54.lpt:417
}, -- ./compiler/lua54.lpt:417
vars[i] -- ./compiler/lua54.lpt:417
} -- ./compiler/lua54.lpt:417
}, "Op")) -- ./compiler/lua54.lpt:417
end -- ./compiler/lua54.lpt:417
end -- ./compiler/lua54.lpt:417
if # destructuringVars > 0 then -- ./compiler/lua54.lpt:420
local destructured = { -- ./compiler/lua54.lpt:421
["rightOp"] = t[2], -- ./compiler/lua54.lpt:421
["leftOp"] = t[4] -- ./compiler/lua54.lpt:421
} -- ./compiler/lua54.lpt:421
r = r .. ("local " .. push("destructuring", destructured) .. lua(destructuringVars, "_lhs") .. pop("destructuring") .. " = " .. lua(destructuringValues, "_lhs")) -- ./compiler/lua54.lpt:422
return r .. DESTRUCTURING_ASSIGN(destructured, nil, true) -- ./compiler/lua54.lpt:423
end -- ./compiler/lua54.lpt:423
return r -- ./compiler/lua54.lpt:425
end -- ./compiler/lua54.lpt:425
end, -- ./compiler/lua54.lpt:425
["AppendSet"] = function(t) -- ./compiler/lua54.lpt:429
local expr = t[# t] -- ./compiler/lua54.lpt:431
local r = {} -- ./compiler/lua54.lpt:432
for i, n in ipairs(t[1]) do -- ./compiler/lua54.lpt:433
local value = expr[i] -- ./compiler/lua54.lpt:434
if value == nil then -- ./compiler/lua54.lpt:435
break -- ./compiler/lua54.lpt:436
end -- ./compiler/lua54.lpt:436
local var = lua(n) -- ./compiler/lua54.lpt:439
r[i] = { -- ./compiler/lua54.lpt:440
var, -- ./compiler/lua54.lpt:440
"[#", -- ./compiler/lua54.lpt:440
var, -- ./compiler/lua54.lpt:440
"+1] = ", -- ./compiler/lua54.lpt:440
lua(value) -- ./compiler/lua54.lpt:440
} -- ./compiler/lua54.lpt:440
r[i] = table["concat"](r[i]) -- ./compiler/lua54.lpt:441
end -- ./compiler/lua54.lpt:441
return table["concat"](r, "; ") -- ./compiler/lua54.lpt:443
end, -- ./compiler/lua54.lpt:443
["While"] = function(t) -- ./compiler/lua54.lpt:446
local r = "" -- ./compiler/lua54.lpt:447
local hasContinue = any(t[2], { "Continue" }, loop) -- ./compiler/lua54.lpt:448
local lets = search({ t[1] }, { "LetExpr" }) -- ./compiler/lua54.lpt:449
if # lets > 0 then -- ./compiler/lua54.lpt:450
r = r .. ("do" .. indent()) -- ./compiler/lua54.lpt:451
for _, l in ipairs(lets) do -- ./compiler/lua54.lpt:452
r = r .. (lua(l, "Let") .. newline()) -- ./compiler/lua54.lpt:453
end -- ./compiler/lua54.lpt:453
end -- ./compiler/lua54.lpt:453
r = r .. ("while " .. lua(t[1]) .. " do" .. indent()) -- ./compiler/lua54.lpt:456
if # lets > 0 then -- ./compiler/lua54.lpt:457
r = r .. ("do" .. indent()) -- ./compiler/lua54.lpt:458
end -- ./compiler/lua54.lpt:458
if hasContinue then -- ./compiler/lua54.lpt:460
r = r .. (CONTINUE_START()) -- ./compiler/lua54.lpt:461
end -- ./compiler/lua54.lpt:461
r = r .. (lua(t[2])) -- ./compiler/lua54.lpt:463
if hasContinue then -- ./compiler/lua54.lpt:464
r = r .. (CONTINUE_STOP()) -- ./compiler/lua54.lpt:465
end -- ./compiler/lua54.lpt:465
r = r .. (unindent() .. "end") -- ./compiler/lua54.lpt:467
if # lets > 0 then -- ./compiler/lua54.lpt:468
for _, l in ipairs(lets) do -- ./compiler/lua54.lpt:469
r = r .. (newline() .. lua(l, "Set")) -- ./compiler/lua54.lpt:470
end -- ./compiler/lua54.lpt:470
r = r .. (unindent() .. "end" .. unindent() .. "end") -- ./compiler/lua54.lpt:472
end -- ./compiler/lua54.lpt:472
return r -- ./compiler/lua54.lpt:474
end, -- ./compiler/lua54.lpt:474
["Repeat"] = function(t) -- ./compiler/lua54.lpt:477
local hasContinue = any(t[1], { "Continue" }, loop) -- ./compiler/lua54.lpt:478
local r = "repeat" .. indent() -- ./compiler/lua54.lpt:479
if hasContinue then -- ./compiler/lua54.lpt:480
r = r .. (CONTINUE_START()) -- ./compiler/lua54.lpt:481
end -- ./compiler/lua54.lpt:481
r = r .. (lua(t[1])) -- ./compiler/lua54.lpt:483
if hasContinue then -- ./compiler/lua54.lpt:484
r = r .. (CONTINUE_STOP()) -- ./compiler/lua54.lpt:485
end -- ./compiler/lua54.lpt:485
r = r .. (unindent() .. "until " .. lua(t[2])) -- ./compiler/lua54.lpt:487
return r -- ./compiler/lua54.lpt:488
end, -- ./compiler/lua54.lpt:488
["If"] = function(t) -- ./compiler/lua54.lpt:491
local r = "" -- ./compiler/lua54.lpt:492
local toClose = 0 -- ./compiler/lua54.lpt:493
local lets = search({ t[1] }, { "LetExpr" }) -- ./compiler/lua54.lpt:494
if # lets > 0 then -- ./compiler/lua54.lpt:495
r = r .. ("do" .. indent()) -- ./compiler/lua54.lpt:496
toClose = toClose + (1) -- ./compiler/lua54.lpt:497
for _, l in ipairs(lets) do -- ./compiler/lua54.lpt:498
r = r .. (lua(l, "Let") .. newline()) -- ./compiler/lua54.lpt:499
end -- ./compiler/lua54.lpt:499
end -- ./compiler/lua54.lpt:499
r = r .. ("if " .. lua(t[1]) .. " then" .. indent() .. lua(t[2]) .. unindent()) -- ./compiler/lua54.lpt:502
for i = 3, # t - 1, 2 do -- ./compiler/lua54.lpt:503
lets = search({ t[i] }, { "LetExpr" }) -- ./compiler/lua54.lpt:504
if # lets > 0 then -- ./compiler/lua54.lpt:505
r = r .. ("else" .. indent()) -- ./compiler/lua54.lpt:506
toClose = toClose + (1) -- ./compiler/lua54.lpt:507
for _, l in ipairs(lets) do -- ./compiler/lua54.lpt:508
r = r .. (lua(l, "Let") .. newline()) -- ./compiler/lua54.lpt:509
end -- ./compiler/lua54.lpt:509
else -- ./compiler/lua54.lpt:509
r = r .. ("else") -- ./compiler/lua54.lpt:512
end -- ./compiler/lua54.lpt:512
r = r .. ("if " .. lua(t[i]) .. " then" .. indent() .. lua(t[i + 1]) .. unindent()) -- ./compiler/lua54.lpt:514
end -- ./compiler/lua54.lpt:514
if # t % 2 == 1 then -- ./compiler/lua54.lpt:516
r = r .. ("else" .. indent() .. lua(t[# t]) .. unindent()) -- ./compiler/lua54.lpt:517
end -- ./compiler/lua54.lpt:517
r = r .. ("end") -- ./compiler/lua54.lpt:519
for i = 1, toClose do -- ./compiler/lua54.lpt:520
r = r .. (unindent() .. "end") -- ./compiler/lua54.lpt:521
end -- ./compiler/lua54.lpt:521
return r -- ./compiler/lua54.lpt:523
end, -- ./compiler/lua54.lpt:523
["Fornum"] = function(t) -- ./compiler/lua54.lpt:526
local r = "for " .. lua(t[1]) .. " = " .. lua(t[2]) .. ", " .. lua(t[3]) -- ./compiler/lua54.lpt:527
if # t == 5 then -- ./compiler/lua54.lpt:528
local hasContinue = any(t[5], { "Continue" }, loop) -- ./compiler/lua54.lpt:529
r = r .. (", " .. lua(t[4]) .. " do" .. indent()) -- ./compiler/lua54.lpt:530
if hasContinue then -- ./compiler/lua54.lpt:531
r = r .. (CONTINUE_START()) -- ./compiler/lua54.lpt:532
end -- ./compiler/lua54.lpt:532
r = r .. (lua(t[5])) -- ./compiler/lua54.lpt:534
if hasContinue then -- ./compiler/lua54.lpt:535
r = r .. (CONTINUE_STOP()) -- ./compiler/lua54.lpt:536
end -- ./compiler/lua54.lpt:536
return r .. unindent() .. "end" -- ./compiler/lua54.lpt:538
else -- ./compiler/lua54.lpt:538
local hasContinue = any(t[4], { "Continue" }, loop) -- ./compiler/lua54.lpt:540
r = r .. (" do" .. indent()) -- ./compiler/lua54.lpt:541
if hasContinue then -- ./compiler/lua54.lpt:542
r = r .. (CONTINUE_START()) -- ./compiler/lua54.lpt:543
end -- ./compiler/lua54.lpt:543
r = r .. (lua(t[4])) -- ./compiler/lua54.lpt:545
if hasContinue then -- ./compiler/lua54.lpt:546
r = r .. (CONTINUE_STOP()) -- ./compiler/lua54.lpt:547
end -- ./compiler/lua54.lpt:547
return r .. unindent() .. "end" -- ./compiler/lua54.lpt:549
end -- ./compiler/lua54.lpt:549
end, -- ./compiler/lua54.lpt:549
["Forin"] = function(t) -- ./compiler/lua54.lpt:553
local destructured = {} -- ./compiler/lua54.lpt:554
local hasContinue = any(t[3], { "Continue" }, loop) -- ./compiler/lua54.lpt:555
local r = "for " .. push("destructuring", destructured) .. lua(t[1], "_lhs") .. pop("destructuring") .. " in " .. lua(t[2], "_lhs") .. " do" .. indent() -- ./compiler/lua54.lpt:556
if hasContinue then -- ./compiler/lua54.lpt:557
r = r .. (CONTINUE_START()) -- ./compiler/lua54.lpt:558
end -- ./compiler/lua54.lpt:558
r = r .. (DESTRUCTURING_ASSIGN(destructured, true) .. lua(t[3])) -- ./compiler/lua54.lpt:560
if hasContinue then -- ./compiler/lua54.lpt:561
r = r .. (CONTINUE_STOP()) -- ./compiler/lua54.lpt:562
end -- ./compiler/lua54.lpt:562
return r .. unindent() .. "end" -- ./compiler/lua54.lpt:564
end, -- ./compiler/lua54.lpt:564
["Local"] = function(t) -- ./compiler/lua54.lpt:567
local destructured = {} -- ./compiler/lua54.lpt:568
local r = "local " .. push("destructuring", destructured) .. lua(t[1], "_lhs") .. pop("destructuring") -- ./compiler/lua54.lpt:569
if t[2][1] then -- ./compiler/lua54.lpt:570
r = r .. (" = " .. lua(t[2], "_lhs")) -- ./compiler/lua54.lpt:571
end -- ./compiler/lua54.lpt:571
return r .. DESTRUCTURING_ASSIGN(destructured) -- ./compiler/lua54.lpt:573
end, -- ./compiler/lua54.lpt:573
["Let"] = function(t) -- ./compiler/lua54.lpt:576
local destructured = {} -- ./compiler/lua54.lpt:577
local nameList = push("destructuring", destructured) .. lua(t[1], "_lhs") .. pop("destructuring") -- ./compiler/lua54.lpt:578
local r = "local " .. nameList -- ./compiler/lua54.lpt:579
if t[2][1] then -- ./compiler/lua54.lpt:580
if all(t[2], { -- ./compiler/lua54.lpt:581
"Nil", -- ./compiler/lua54.lpt:581
"Dots", -- ./compiler/lua54.lpt:581
"Boolean", -- ./compiler/lua54.lpt:581
"Number", -- ./compiler/lua54.lpt:581
"String" -- ./compiler/lua54.lpt:581
}) then -- ./compiler/lua54.lpt:581
r = r .. (" = " .. lua(t[2], "_lhs")) -- ./compiler/lua54.lpt:582
else -- ./compiler/lua54.lpt:582
r = r .. (newline() .. nameList .. " = " .. lua(t[2], "_lhs")) -- ./compiler/lua54.lpt:584
end -- ./compiler/lua54.lpt:584
end -- ./compiler/lua54.lpt:584
return r .. DESTRUCTURING_ASSIGN(destructured) -- ./compiler/lua54.lpt:587
end, -- ./compiler/lua54.lpt:587
["Localrec"] = function(t) -- ./compiler/lua54.lpt:590
return "local function " .. lua(t[1][1]) .. lua(t[2][1], "_functionWithoutKeyword") -- ./compiler/lua54.lpt:591
end, -- ./compiler/lua54.lpt:591
["Goto"] = function(t) -- ./compiler/lua54.lpt:594
return "goto " .. lua(t, "Id") -- ./compiler/lua54.lpt:595
end, -- ./compiler/lua54.lpt:595
["Label"] = function(t) -- ./compiler/lua54.lpt:598
return "::" .. lua(t, "Id") .. "::" -- ./compiler/lua54.lpt:599
end, -- ./compiler/lua54.lpt:599
["Return"] = function(t) -- ./compiler/lua54.lpt:602
local push = peek("push") -- ./compiler/lua54.lpt:603
if push then -- ./compiler/lua54.lpt:604
local r = "" -- ./compiler/lua54.lpt:605
for _, val in ipairs(t) do -- ./compiler/lua54.lpt:606
r = r .. (push .. "[#" .. push .. "+1] = " .. lua(val) .. newline()) -- ./compiler/lua54.lpt:607
end -- ./compiler/lua54.lpt:607
return r .. "return " .. UNPACK(push) -- ./compiler/lua54.lpt:609
else -- ./compiler/lua54.lpt:609
return "return " .. lua(t, "_lhs") -- ./compiler/lua54.lpt:611
end -- ./compiler/lua54.lpt:611
end, -- ./compiler/lua54.lpt:611
["Push"] = function(t) -- ./compiler/lua54.lpt:615
local var = assert(peek("push"), "no context given for push") -- ./compiler/lua54.lpt:616
r = "" -- ./compiler/lua54.lpt:617
for i = 1, # t - 1, 1 do -- ./compiler/lua54.lpt:618
r = r .. (var .. "[#" .. var .. "+1] = " .. lua(t[i]) .. newline()) -- ./compiler/lua54.lpt:619
end -- ./compiler/lua54.lpt:619
if t[# t] then -- ./compiler/lua54.lpt:621
if t[# t]["tag"] == "Call" then -- ./compiler/lua54.lpt:622
r = r .. (APPEND(var, lua(t[# t]))) -- ./compiler/lua54.lpt:623
else -- ./compiler/lua54.lpt:623
r = r .. (var .. "[#" .. var .. "+1] = " .. lua(t[# t])) -- ./compiler/lua54.lpt:625
end -- ./compiler/lua54.lpt:625
end -- ./compiler/lua54.lpt:625
return r -- ./compiler/lua54.lpt:628
end, -- ./compiler/lua54.lpt:628
["Break"] = function() -- ./compiler/lua54.lpt:631
return "break" -- ./compiler/lua54.lpt:632
end, -- ./compiler/lua54.lpt:632
["Continue"] = function() -- ./compiler/lua54.lpt:635
return "goto " .. var("continue") -- ./compiler/lua54.lpt:636
end, -- ./compiler/lua54.lpt:636
["Nil"] = function() -- ./compiler/lua54.lpt:643
return "nil" -- ./compiler/lua54.lpt:644
end, -- ./compiler/lua54.lpt:644
["Dots"] = function() -- ./compiler/lua54.lpt:647
local macroargs = peek("macroargs") -- ./compiler/lua54.lpt:648
if macroargs and not nomacro["variables"]["..."] and macroargs["..."] then -- ./compiler/lua54.lpt:649
nomacro["variables"]["..."] = true -- ./compiler/lua54.lpt:650
local r = lua(macroargs["..."], "_lhs") -- ./compiler/lua54.lpt:651
nomacro["variables"]["..."] = nil -- ./compiler/lua54.lpt:652
return r -- ./compiler/lua54.lpt:653
else -- ./compiler/lua54.lpt:653
return "..." -- ./compiler/lua54.lpt:655
end -- ./compiler/lua54.lpt:655
end, -- ./compiler/lua54.lpt:655
["Boolean"] = function(t) -- ./compiler/lua54.lpt:659
return tostring(t[1]) -- ./compiler/lua54.lpt:660
end, -- ./compiler/lua54.lpt:660
["Number"] = function(t) -- ./compiler/lua54.lpt:663
local n = tostring(t[1]):gsub("_", "") -- ./compiler/lua54.lpt:664
do -- ./compiler/lua54.lpt:666
local match -- ./compiler/lua54.lpt:666
match = n:match("^0b(.*)") -- ./compiler/lua54.lpt:666
if match then -- ./compiler/lua54.lpt:666
n = tostring(tonumber(match, 2)) -- ./compiler/lua54.lpt:667
end -- ./compiler/lua54.lpt:667
end -- ./compiler/lua54.lpt:667
return n -- ./compiler/lua54.lpt:669
end, -- ./compiler/lua54.lpt:669
["String"] = function(t) -- ./compiler/lua54.lpt:672
return ("%q"):format(t[1]) -- ./compiler/lua54.lpt:673
end, -- ./compiler/lua54.lpt:673
["_functionWithoutKeyword"] = function(t) -- ./compiler/lua54.lpt:676
local r = "(" -- ./compiler/lua54.lpt:677
local decl = {} -- ./compiler/lua54.lpt:678
if t[1][1] then -- ./compiler/lua54.lpt:679
if t[1][1]["tag"] == "ParPair" then -- ./compiler/lua54.lpt:680
local id = lua(t[1][1][1]) -- ./compiler/lua54.lpt:681
indentLevel = indentLevel + (1) -- ./compiler/lua54.lpt:682
table["insert"](decl, "if " .. id .. " == nil then " .. id .. " = " .. lua(t[1][1][2]) .. " end") -- ./compiler/lua54.lpt:683
indentLevel = indentLevel - (1) -- ./compiler/lua54.lpt:684
r = r .. (id) -- ./compiler/lua54.lpt:685
else -- ./compiler/lua54.lpt:685
r = r .. (lua(t[1][1])) -- ./compiler/lua54.lpt:687
end -- ./compiler/lua54.lpt:687
for i = 2, # t[1], 1 do -- ./compiler/lua54.lpt:689
if t[1][i]["tag"] == "ParPair" then -- ./compiler/lua54.lpt:690
local id = lua(t[1][i][1]) -- ./compiler/lua54.lpt:691
indentLevel = indentLevel + (1) -- ./compiler/lua54.lpt:692
table["insert"](decl, "if " .. id .. " == nil then " .. id .. " = " .. lua(t[1][i][2]) .. " end") -- ./compiler/lua54.lpt:693
indentLevel = indentLevel - (1) -- ./compiler/lua54.lpt:694
r = r .. (", " .. id) -- ./compiler/lua54.lpt:695
else -- ./compiler/lua54.lpt:695
r = r .. (", " .. lua(t[1][i])) -- ./compiler/lua54.lpt:697
end -- ./compiler/lua54.lpt:697
end -- ./compiler/lua54.lpt:697
end -- ./compiler/lua54.lpt:697
r = r .. (")" .. indent()) -- ./compiler/lua54.lpt:701
for _, d in ipairs(decl) do -- ./compiler/lua54.lpt:702
r = r .. (d .. newline()) -- ./compiler/lua54.lpt:703
end -- ./compiler/lua54.lpt:703
if t[2][# t[2]] and t[2][# t[2]]["tag"] == "Push" then -- ./compiler/lua54.lpt:705
t[2][# t[2]]["tag"] = "Return" -- ./compiler/lua54.lpt:706
end -- ./compiler/lua54.lpt:706
local hasPush = any(t[2], { "Push" }, func) -- ./compiler/lua54.lpt:708
if hasPush then -- ./compiler/lua54.lpt:709
r = r .. (push("push", var("push")) .. "local " .. var("push") .. " = {}" .. newline()) -- ./compiler/lua54.lpt:710
else -- ./compiler/lua54.lpt:710
push("push", false) -- ./compiler/lua54.lpt:712
end -- ./compiler/lua54.lpt:712
r = r .. (lua(t[2])) -- ./compiler/lua54.lpt:714
if hasPush and (t[2][# t[2]] and t[2][# t[2]]["tag"] ~= "Return") then -- ./compiler/lua54.lpt:715
r = r .. (newline() .. "return " .. UNPACK(var("push"))) -- ./compiler/lua54.lpt:716
end -- ./compiler/lua54.lpt:716
pop("push") -- ./compiler/lua54.lpt:718
return r .. unindent() .. "end" -- ./compiler/lua54.lpt:719
end, -- ./compiler/lua54.lpt:719
["Function"] = function(t) -- ./compiler/lua54.lpt:721
return "function" .. lua(t, "_functionWithoutKeyword") -- ./compiler/lua54.lpt:722
end, -- ./compiler/lua54.lpt:722
["Pair"] = function(t) -- ./compiler/lua54.lpt:725
return "[" .. lua(t[1]) .. "] = " .. lua(t[2]) -- ./compiler/lua54.lpt:726
end, -- ./compiler/lua54.lpt:726
["Table"] = function(t) -- ./compiler/lua54.lpt:728
if # t == 0 then -- ./compiler/lua54.lpt:729
return "{}" -- ./compiler/lua54.lpt:730
elseif # t == 1 then -- ./compiler/lua54.lpt:731
return "{ " .. lua(t, "_lhs") .. " }" -- ./compiler/lua54.lpt:732
else -- ./compiler/lua54.lpt:732
return "{" .. indent() .. lua(t, "_lhs", nil, true) .. unindent() .. "}" -- ./compiler/lua54.lpt:734
end -- ./compiler/lua54.lpt:734
end, -- ./compiler/lua54.lpt:734
["TableCompr"] = function(t) -- ./compiler/lua54.lpt:738
return push("push", "self") .. "(function()" .. indent() .. "local self = {}" .. newline() .. lua(t[1]) .. newline() .. "return self" .. unindent() .. "end)()" .. pop("push") -- ./compiler/lua54.lpt:739
end, -- ./compiler/lua54.lpt:739
["Op"] = function(t) -- ./compiler/lua54.lpt:742
local r -- ./compiler/lua54.lpt:743
if # t == 2 then -- ./compiler/lua54.lpt:744
if type(tags["_opid"][t[1]]) == "string" then -- ./compiler/lua54.lpt:745
r = tags["_opid"][t[1]] .. " " .. lua(t[2]) -- ./compiler/lua54.lpt:746
else -- ./compiler/lua54.lpt:746
r = tags["_opid"][t[1]](t[2]) -- ./compiler/lua54.lpt:748
end -- ./compiler/lua54.lpt:748
else -- ./compiler/lua54.lpt:748
if type(tags["_opid"][t[1]]) == "string" then -- ./compiler/lua54.lpt:751
r = lua(t[2]) .. " " .. tags["_opid"][t[1]] .. " " .. lua(t[3]) -- ./compiler/lua54.lpt:752
else -- ./compiler/lua54.lpt:752
r = tags["_opid"][t[1]](t[2], t[3]) -- ./compiler/lua54.lpt:754
end -- ./compiler/lua54.lpt:754
end -- ./compiler/lua54.lpt:754
return r -- ./compiler/lua54.lpt:757
end, -- ./compiler/lua54.lpt:757
["Paren"] = function(t) -- ./compiler/lua54.lpt:760
return "(" .. lua(t[1]) .. ")" -- ./compiler/lua54.lpt:761
end, -- ./compiler/lua54.lpt:761
["MethodStub"] = function(t) -- ./compiler/lua54.lpt:764
return "(function()" .. indent() .. "local " .. var("object") .. " = " .. lua(t[1]) .. newline() .. "local " .. var("method") .. " = " .. var("object") .. "." .. lua(t[2], "Id") .. newline() .. "if " .. var("method") .. " == nil then return nil end" .. newline() .. "return function(...) return " .. var("method") .. "(" .. var("object") .. ", ...) end" .. unindent() .. "end)()" -- ./compiler/lua54.lpt:770
end, -- ./compiler/lua54.lpt:770
["SafeMethodStub"] = function(t) -- ./compiler/lua54.lpt:773
return "(function()" .. indent() .. "local " .. var("object") .. " = " .. lua(t[1]) .. newline() .. "if " .. var("object") .. " == nil then return nil end" .. newline() .. "local " .. var("method") .. " = " .. var("object") .. "." .. lua(t[2], "Id") .. newline() .. "if " .. var("method") .. " == nil then return nil end" .. newline() .. "return function(...) return " .. var("method") .. "(" .. var("object") .. ", ...) end" .. unindent() .. "end)()" -- ./compiler/lua54.lpt:780
end, -- ./compiler/lua54.lpt:780
["LetExpr"] = function(t) -- ./compiler/lua54.lpt:787
return lua(t[1][1]) -- ./compiler/lua54.lpt:788
end, -- ./compiler/lua54.lpt:788
["_statexpr"] = function(t, stat) -- ./compiler/lua54.lpt:792
local hasPush = any(t, { "Push" }, func) -- ./compiler/lua54.lpt:793
local r = "(function()" .. indent() -- ./compiler/lua54.lpt:794
if hasPush then -- ./compiler/lua54.lpt:795
r = r .. (push("push", var("push")) .. "local " .. var("push") .. " = {}" .. newline()) -- ./compiler/lua54.lpt:796
else -- ./compiler/lua54.lpt:796
push("push", false) -- ./compiler/lua54.lpt:798
end -- ./compiler/lua54.lpt:798
r = r .. (lua(t, stat)) -- ./compiler/lua54.lpt:800
if hasPush then -- ./compiler/lua54.lpt:801
r = r .. (newline() .. "return " .. UNPACK(var("push"))) -- ./compiler/lua54.lpt:802
end -- ./compiler/lua54.lpt:802
pop("push") -- ./compiler/lua54.lpt:804
r = r .. (unindent() .. "end)()") -- ./compiler/lua54.lpt:805
return r -- ./compiler/lua54.lpt:806
end, -- ./compiler/lua54.lpt:806
["DoExpr"] = function(t) -- ./compiler/lua54.lpt:809
if t[# t]["tag"] == "Push" then -- ./compiler/lua54.lpt:810
t[# t]["tag"] = "Return" -- ./compiler/lua54.lpt:811
end -- ./compiler/lua54.lpt:811
return lua(t, "_statexpr", "Do") -- ./compiler/lua54.lpt:813
end, -- ./compiler/lua54.lpt:813
["WhileExpr"] = function(t) -- ./compiler/lua54.lpt:816
return lua(t, "_statexpr", "While") -- ./compiler/lua54.lpt:817
end, -- ./compiler/lua54.lpt:817
["RepeatExpr"] = function(t) -- ./compiler/lua54.lpt:820
return lua(t, "_statexpr", "Repeat") -- ./compiler/lua54.lpt:821
end, -- ./compiler/lua54.lpt:821
["IfExpr"] = function(t) -- ./compiler/lua54.lpt:824
for i = 2, # t do -- ./compiler/lua54.lpt:825
local block = t[i] -- ./compiler/lua54.lpt:826
if block[# block] and block[# block]["tag"] == "Push" then -- ./compiler/lua54.lpt:827
block[# block]["tag"] = "Return" -- ./compiler/lua54.lpt:828
end -- ./compiler/lua54.lpt:828
end -- ./compiler/lua54.lpt:828
return lua(t, "_statexpr", "If") -- ./compiler/lua54.lpt:831
end, -- ./compiler/lua54.lpt:831
["FornumExpr"] = function(t) -- ./compiler/lua54.lpt:834
return lua(t, "_statexpr", "Fornum") -- ./compiler/lua54.lpt:835
end, -- ./compiler/lua54.lpt:835
["ForinExpr"] = function(t) -- ./compiler/lua54.lpt:838
return lua(t, "_statexpr", "Forin") -- ./compiler/lua54.lpt:839
end, -- ./compiler/lua54.lpt:839
["Call"] = function(t) -- ./compiler/lua54.lpt:846
if t[1]["tag"] == "String" or t[1]["tag"] == "Table" then -- ./compiler/lua54.lpt:847
return "(" .. lua(t[1]) .. ")(" .. lua(t, "_lhs", 2) .. ")" -- ./compiler/lua54.lpt:848
elseif t[1]["tag"] == "Id" and not nomacro["functions"][t[1][1]] and macros["functions"][t[1][1]] then -- ./compiler/lua54.lpt:849
local macro = macros["functions"][t[1][1]] -- ./compiler/lua54.lpt:850
local replacement = macro["replacement"] -- ./compiler/lua54.lpt:851
local r -- ./compiler/lua54.lpt:852
nomacro["functions"][t[1][1]] = true -- ./compiler/lua54.lpt:853
if type(replacement) == "function" then -- ./compiler/lua54.lpt:854
local args = {} -- ./compiler/lua54.lpt:855
for i = 2, # t do -- ./compiler/lua54.lpt:856
table["insert"](args, lua(t[i])) -- ./compiler/lua54.lpt:857
end -- ./compiler/lua54.lpt:857
r = replacement(unpack(args)) -- ./compiler/lua54.lpt:859
else -- ./compiler/lua54.lpt:859
local macroargs = util["merge"](peek("macroargs")) -- ./compiler/lua54.lpt:861
for i, arg in ipairs(macro["args"]) do -- ./compiler/lua54.lpt:862
if arg["tag"] == "Dots" then -- ./compiler/lua54.lpt:863
macroargs["..."] = (function() -- ./compiler/lua54.lpt:864
local self = {} -- ./compiler/lua54.lpt:864
for j = i + 1, # t do -- ./compiler/lua54.lpt:864
self[#self+1] = t[j] -- ./compiler/lua54.lpt:864
end -- ./compiler/lua54.lpt:864
return self -- ./compiler/lua54.lpt:864
end)() -- ./compiler/lua54.lpt:864
elseif arg["tag"] == "Id" then -- ./compiler/lua54.lpt:865
if t[i + 1] == nil then -- ./compiler/lua54.lpt:866
error(("bad argument #%s to macro %s (value expected)"):format(i, t[1][1])) -- ./compiler/lua54.lpt:867
end -- ./compiler/lua54.lpt:867
macroargs[arg[1]] = t[i + 1] -- ./compiler/lua54.lpt:869
else -- ./compiler/lua54.lpt:869
error(("unexpected argument type %s in macro %s"):format(arg["tag"], t[1][1])) -- ./compiler/lua54.lpt:871
end -- ./compiler/lua54.lpt:871
end -- ./compiler/lua54.lpt:871
push("macroargs", macroargs) -- ./compiler/lua54.lpt:874
r = lua(replacement) -- ./compiler/lua54.lpt:875
pop("macroargs") -- ./compiler/lua54.lpt:876
end -- ./compiler/lua54.lpt:876
nomacro["functions"][t[1][1]] = nil -- ./compiler/lua54.lpt:878
return r -- ./compiler/lua54.lpt:879
elseif t[1]["tag"] == "MethodStub" then -- ./compiler/lua54.lpt:880
if t[1][1]["tag"] == "String" or t[1][1]["tag"] == "Table" then -- ./compiler/lua54.lpt:881
return "(" .. lua(t[1][1]) .. "):" .. lua(t[1][2], "Id") .. "(" .. lua(t, "_lhs", 2) .. ")" -- ./compiler/lua54.lpt:882
else -- ./compiler/lua54.lpt:882
return lua(t[1][1]) .. ":" .. lua(t[1][2], "Id") .. "(" .. lua(t, "_lhs", 2) .. ")" -- ./compiler/lua54.lpt:884
end -- ./compiler/lua54.lpt:884
else -- ./compiler/lua54.lpt:884
return lua(t[1]) .. "(" .. lua(t, "_lhs", 2) .. ")" -- ./compiler/lua54.lpt:887
end -- ./compiler/lua54.lpt:887
end, -- ./compiler/lua54.lpt:887
["SafeCall"] = function(t) -- ./compiler/lua54.lpt:891
if t[1]["tag"] ~= "Id" then -- ./compiler/lua54.lpt:892
return lua(t, "SafeIndex") -- ./compiler/lua54.lpt:893
else -- ./compiler/lua54.lpt:893
return "(" .. lua(t[1]) .. " ~= nil and " .. lua(t[1]) .. "(" .. lua(t, "_lhs", 2) .. ") or nil)" -- ./compiler/lua54.lpt:895
end -- ./compiler/lua54.lpt:895
end, -- ./compiler/lua54.lpt:895
["Broadcast"] = function(t) -- ./compiler/lua54.lpt:901
return BROADCAST(t, false) -- ./compiler/lua54.lpt:902
end, -- ./compiler/lua54.lpt:902
["BroadcastKV"] = function(t) -- ./compiler/lua54.lpt:904
return BROADCAST(t, true) -- ./compiler/lua54.lpt:905
end, -- ./compiler/lua54.lpt:905
["Filter"] = function(t) -- ./compiler/lua54.lpt:907
return FILTER(t, false) -- ./compiler/lua54.lpt:908
end, -- ./compiler/lua54.lpt:908
["FilterKV"] = function(t) -- ./compiler/lua54.lpt:910
return FILTER(t, true) -- ./compiler/lua54.lpt:911
end, -- ./compiler/lua54.lpt:911
["StringFormat"] = function(t) -- ./compiler/lua54.lpt:916
local args = {} -- ./compiler/lua54.lpt:917
for _, v in ipairs(t[2]) do -- ./compiler/lua54.lpt:918
args[# args + 1] = lua(v) -- ./compiler/lua54.lpt:919
end -- ./compiler/lua54.lpt:919
local r = { -- ./compiler/lua54.lpt:921
"(", -- ./compiler/lua54.lpt:921
"string.format(", -- ./compiler/lua54.lpt:921
("%q"):format(t[1]) -- ./compiler/lua54.lpt:921
} -- ./compiler/lua54.lpt:921
if # args ~= 0 then -- ./compiler/lua54.lpt:922
r[# r + 1] = ", " -- ./compiler/lua54.lpt:923
r[# r + 1] = table["concat"](args, ", ") -- ./compiler/lua54.lpt:924
r[# r + 1] = "))" -- ./compiler/lua54.lpt:925
end -- ./compiler/lua54.lpt:925
return table["concat"](r) -- ./compiler/lua54.lpt:927
end, -- ./compiler/lua54.lpt:927
["_lhs"] = function(t, start, newlines) -- ./compiler/lua54.lpt:932
if start == nil then start = 1 end -- ./compiler/lua54.lpt:932
local r -- ./compiler/lua54.lpt:933
if t[start] then -- ./compiler/lua54.lpt:934
r = lua(t[start]) -- ./compiler/lua54.lpt:935
for i = start + 1, # t, 1 do -- ./compiler/lua54.lpt:936
r = r .. ("," .. (newlines and newline() or " ") .. lua(t[i])) -- ./compiler/lua54.lpt:937
end -- ./compiler/lua54.lpt:937
else -- ./compiler/lua54.lpt:937
r = "" -- ./compiler/lua54.lpt:940
end -- ./compiler/lua54.lpt:940
return r -- ./compiler/lua54.lpt:942
end, -- ./compiler/lua54.lpt:942
["Id"] = function(t) -- ./compiler/lua54.lpt:945
local r = t[1] -- ./compiler/lua54.lpt:946
local macroargs = peek("macroargs") -- ./compiler/lua54.lpt:947
if not nomacro["variables"][t[1]] then -- ./compiler/lua54.lpt:948
nomacro["variables"][t[1]] = true -- ./compiler/lua54.lpt:949
if macroargs and macroargs[t[1]] then -- ./compiler/lua54.lpt:950
r = lua(macroargs[t[1]]) -- ./compiler/lua54.lpt:951
elseif macros["variables"][t[1]] ~= nil then -- ./compiler/lua54.lpt:952
local macro = macros["variables"][t[1]] -- ./compiler/lua54.lpt:953
if type(macro) == "function" then -- ./compiler/lua54.lpt:954
r = macro() -- ./compiler/lua54.lpt:955
else -- ./compiler/lua54.lpt:955
r = lua(macro) -- ./compiler/lua54.lpt:957
end -- ./compiler/lua54.lpt:957
end -- ./compiler/lua54.lpt:957
nomacro["variables"][t[1]] = nil -- ./compiler/lua54.lpt:960
end -- ./compiler/lua54.lpt:960
return r -- ./compiler/lua54.lpt:962
end, -- ./compiler/lua54.lpt:962
["AttributeId"] = function(t) -- ./compiler/lua54.lpt:965
if t[2] then -- ./compiler/lua54.lpt:966
return t[1] .. " <" .. t[2] .. ">" -- ./compiler/lua54.lpt:967
else -- ./compiler/lua54.lpt:967
return t[1] -- ./compiler/lua54.lpt:969
end -- ./compiler/lua54.lpt:969
end, -- ./compiler/lua54.lpt:969
["DestructuringId"] = function(t) -- ./compiler/lua54.lpt:973
if t["id"] then -- ./compiler/lua54.lpt:974
return t["id"] -- ./compiler/lua54.lpt:975
else -- ./compiler/lua54.lpt:975
local d = assert(peek("destructuring"), "DestructuringId not in a destructurable assignement") -- ./compiler/lua54.lpt:977
local vars = { ["id"] = tmp() } -- ./compiler/lua54.lpt:978
for j = 1, # t, 1 do -- ./compiler/lua54.lpt:979
table["insert"](vars, t[j]) -- ./compiler/lua54.lpt:980
end -- ./compiler/lua54.lpt:980
table["insert"](d, vars) -- ./compiler/lua54.lpt:982
t["id"] = vars["id"] -- ./compiler/lua54.lpt:983
return vars["id"] -- ./compiler/lua54.lpt:984
end -- ./compiler/lua54.lpt:984
end, -- ./compiler/lua54.lpt:984
["Index"] = function(t) -- ./compiler/lua54.lpt:988
if t[1]["tag"] == "String" or t[1]["tag"] == "Table" then -- ./compiler/lua54.lpt:989
return "(" .. lua(t[1]) .. ")[" .. lua(t[2]) .. "]" -- ./compiler/lua54.lpt:990
else -- ./compiler/lua54.lpt:990
return lua(t[1]) .. "[" .. lua(t[2]) .. "]" -- ./compiler/lua54.lpt:992
end -- ./compiler/lua54.lpt:992
end, -- ./compiler/lua54.lpt:992
["SafeIndex"] = function(t) -- ./compiler/lua54.lpt:996
if t[1]["tag"] ~= "Id" then -- ./compiler/lua54.lpt:997
local l = {} -- ./compiler/lua54.lpt:998
while t["tag"] == "SafeIndex" or t["tag"] == "SafeCall" do -- ./compiler/lua54.lpt:999
table["insert"](l, 1, t) -- ./compiler/lua54.lpt:1000
t = t[1] -- ./compiler/lua54.lpt:1001
end -- ./compiler/lua54.lpt:1001
local r = "(function()" .. indent() .. "local " .. var("safe") .. " = " .. lua(l[1][1]) .. newline() -- ./compiler/lua54.lpt:1003
for _, e in ipairs(l) do -- ./compiler/lua54.lpt:1004
r = r .. ("if " .. var("safe") .. " == nil then return nil end" .. newline()) -- ./compiler/lua54.lpt:1005
if e["tag"] == "SafeIndex" then -- ./compiler/lua54.lpt:1006
r = r .. (var("safe") .. " = " .. var("safe") .. "[" .. lua(e[2]) .. "]" .. newline()) -- ./compiler/lua54.lpt:1007
else -- ./compiler/lua54.lpt:1007
r = r .. (var("safe") .. " = " .. var("safe") .. "(" .. lua(e, "_lhs", 2) .. ")" .. newline()) -- ./compiler/lua54.lpt:1009
end -- ./compiler/lua54.lpt:1009
end -- ./compiler/lua54.lpt:1009
r = r .. ("return " .. var("safe") .. unindent() .. "end)()") -- ./compiler/lua54.lpt:1012
return r -- ./compiler/lua54.lpt:1013
else -- ./compiler/lua54.lpt:1013
return "(" .. lua(t[1]) .. " ~= nil and " .. lua(t[1]) .. "[" .. lua(t[2]) .. "] or nil)" -- ./compiler/lua54.lpt:1015
end -- ./compiler/lua54.lpt:1015
end, -- ./compiler/lua54.lpt:1015
["_opid"] = { -- ./compiler/lua54.lpt:1021
["add"] = "+", -- ./compiler/lua54.lpt:1023
["sub"] = "-", -- ./compiler/lua54.lpt:1023
["mul"] = "*", -- ./compiler/lua54.lpt:1023
["div"] = "/", -- ./compiler/lua54.lpt:1023
["idiv"] = "//", -- ./compiler/lua54.lpt:1024
["mod"] = "%", -- ./compiler/lua54.lpt:1024
["pow"] = "^", -- ./compiler/lua54.lpt:1024
["concat"] = "..", -- ./compiler/lua54.lpt:1024
["band"] = "&", -- ./compiler/lua54.lpt:1025
["bor"] = "|", -- ./compiler/lua54.lpt:1025
["bxor"] = "~", -- ./compiler/lua54.lpt:1025
["shl"] = "<<", -- ./compiler/lua54.lpt:1025
["shr"] = ">>", -- ./compiler/lua54.lpt:1025
["eq"] = "==", -- ./compiler/lua54.lpt:1026
["ne"] = "~=", -- ./compiler/lua54.lpt:1026
["lt"] = "<", -- ./compiler/lua54.lpt:1026
["gt"] = ">", -- ./compiler/lua54.lpt:1026
["le"] = "<=", -- ./compiler/lua54.lpt:1026
["ge"] = ">=", -- ./compiler/lua54.lpt:1026
["and"] = "and", -- ./compiler/lua54.lpt:1027
["or"] = "or", -- ./compiler/lua54.lpt:1027
["unm"] = "-", -- ./compiler/lua54.lpt:1027
["len"] = "#", -- ./compiler/lua54.lpt:1027
["bnot"] = "~", -- ./compiler/lua54.lpt:1027
["not"] = "not", -- ./compiler/lua54.lpt:1027
["divb"] = function(left, right) -- ./compiler/lua54.lpt:1031
return table["concat"]({ -- ./compiler/lua54.lpt:1032
"((", -- ./compiler/lua54.lpt:1032
lua(left), -- ./compiler/lua54.lpt:1032
") % (", -- ./compiler/lua54.lpt:1032
lua(right), -- ./compiler/lua54.lpt:1032
") == 0)" -- ./compiler/lua54.lpt:1032
}) -- ./compiler/lua54.lpt:1032
end, -- ./compiler/lua54.lpt:1032
["ndivb"] = function(left, right) -- ./compiler/lua54.lpt:1035
return table["concat"]({ -- ./compiler/lua54.lpt:1036
"((", -- ./compiler/lua54.lpt:1036
lua(left), -- ./compiler/lua54.lpt:1036
") % (", -- ./compiler/lua54.lpt:1036
lua(right), -- ./compiler/lua54.lpt:1036
") ~= 0)" -- ./compiler/lua54.lpt:1036
}) -- ./compiler/lua54.lpt:1036
end, -- ./compiler/lua54.lpt:1036
["tconcat"] = function(left, right) -- ./compiler/lua54.lpt:1041
if right["tag"] == "Table" then -- ./compiler/lua54.lpt:1042
local sep = right[1] -- ./compiler/lua54.lpt:1043
local i = right[2] -- ./compiler/lua54.lpt:1044
local j = right[3] -- ./compiler/lua54.lpt:1045
local r = { -- ./compiler/lua54.lpt:1047
"table.concat(", -- ./compiler/lua54.lpt:1047
lua(left) -- ./compiler/lua54.lpt:1047
} -- ./compiler/lua54.lpt:1047
if sep ~= nil then -- ./compiler/lua54.lpt:1049
r[# r + 1] = ", " -- ./compiler/lua54.lpt:1050
r[# r + 1] = lua(sep) -- ./compiler/lua54.lpt:1051
end -- ./compiler/lua54.lpt:1051
if i ~= nil then -- ./compiler/lua54.lpt:1054
r[# r + 1] = ", " -- ./compiler/lua54.lpt:1055
r[# r + 1] = lua(i) -- ./compiler/lua54.lpt:1056
end -- ./compiler/lua54.lpt:1056
if j ~= nil then -- ./compiler/lua54.lpt:1059
r[# r + 1] = ", " -- ./compiler/lua54.lpt:1060
r[# r + 1] = lua(j) -- ./compiler/lua54.lpt:1061
end -- ./compiler/lua54.lpt:1061
r[# r + 1] = ")" -- ./compiler/lua54.lpt:1064
return table["concat"](r) -- ./compiler/lua54.lpt:1066
else -- ./compiler/lua54.lpt:1066
return table["concat"]({ -- ./compiler/lua54.lpt:1068
"table.concat(", -- ./compiler/lua54.lpt:1068
lua(left), -- ./compiler/lua54.lpt:1068
", ", -- ./compiler/lua54.lpt:1068
lua(right), -- ./compiler/lua54.lpt:1068
")" -- ./compiler/lua54.lpt:1068
}) -- ./compiler/lua54.lpt:1068
end -- ./compiler/lua54.lpt:1068
end, -- ./compiler/lua54.lpt:1068
["pipe"] = function(left, right) -- ./compiler/lua54.lpt:1074
return table["concat"]({ -- ./compiler/lua54.lpt:1075
"(", -- ./compiler/lua54.lpt:1075
lua(right), -- ./compiler/lua54.lpt:1075
")", -- ./compiler/lua54.lpt:1075
"(", -- ./compiler/lua54.lpt:1075
lua(left), -- ./compiler/lua54.lpt:1075
")" -- ./compiler/lua54.lpt:1075
}) -- ./compiler/lua54.lpt:1075
end, -- ./compiler/lua54.lpt:1075
["pipebc"] = function(left, right) -- ./compiler/lua54.lpt:1077
return table["concat"]({ BROADCAST({ -- ./compiler/lua54.lpt:1078
right, -- ./compiler/lua54.lpt:1078
left -- ./compiler/lua54.lpt:1078
}, false) }) -- ./compiler/lua54.lpt:1078
end, -- ./compiler/lua54.lpt:1078
["pipebckv"] = function(left, right) -- ./compiler/lua54.lpt:1080
return table["concat"]({ BROADCAST({ -- ./compiler/lua54.lpt:1081
right, -- ./compiler/lua54.lpt:1081
left -- ./compiler/lua54.lpt:1081
}, true) }) -- ./compiler/lua54.lpt:1081
end -- ./compiler/lua54.lpt:1081
} -- ./compiler/lua54.lpt:1081
}, { ["__index"] = function(self, key) -- ./compiler/lua54.lpt:1093
error("don't know how to compile a " .. tostring(key) .. " to " .. targetName) -- ./compiler/lua54.lpt:1094
end }) -- ./compiler/lua54.lpt:1094
local code = lua(ast) .. newline() -- ./compiler/lua54.lpt:1101
return requireStr .. luaHeader .. code -- ./compiler/lua54.lpt:1102
end -- ./compiler/lua54.lpt:1102
end -- ./compiler/lua54.lpt:1102
local lua54 = _() or lua54 -- ./compiler/lua54.lpt:1107
package["loaded"]["compiler.lua54"] = lua54 or true -- ./compiler/lua54.lpt:1108
local function _() -- ./compiler/lua54.lpt:1111
local function _() -- ./compiler/lua54.lpt:1113
local util = require("lepton.util") -- ./compiler/lua54.lpt:1
local targetName = "Lua 5.4" -- ./compiler/lua54.lpt:3
local unpack = unpack or table["unpack"] -- ./compiler/lua54.lpt:5
return function(code, ast, options, macros) -- ./compiler/lua54.lpt:7
...
if tag == "Nil" or tag == "Boolean" or tag == "Number" or tag == "String" or tag == "StringFormat" then -- ./lepton/lpt-parser/validator.lua:344
return true -- ./lepton/lpt-parser/validator.lua:345
elseif tag == "Dots" then -- ./lepton/lpt-parser/validator.lua:346
return traverse_vararg(env, exp) -- ./lepton/lpt-parser/validator.lua:347
elseif tag == "Function" then -- ./lepton/lpt-parser/validator.lua:348
return traverse_function(env, exp) -- ./lepton/lpt-parser/validator.lua:349
elseif tag == "Table" then -- ./lepton/lpt-parser/validator.lua:350
return traverse_table(env, exp) -- ./lepton/lpt-parser/validator.lua:351
elseif tag == "Op" then -- ./lepton/lpt-parser/validator.lua:352
return traverse_op(env, exp) -- ./lepton/lpt-parser/validator.lua:353
elseif tag == "Paren" then -- ./lepton/lpt-parser/validator.lua:354
return traverse_paren(env, exp) -- ./lepton/lpt-parser/validator.lua:355
elseif tag == "Call" or tag == "SafeCall" or tag == "Broadcast" or tag == "BroadcastKV" or tag == "Filter" or tag == "FilterKV" then -- ./lepton/lpt-parser/validator.lua:356
return traverse_call(env, exp) -- ./lepton/lpt-parser/validator.lua:357
elseif tag == "Id" or tag == "Index" then -- ./lepton/lpt-parser/validator.lua:359
return traverse_var(env, exp) -- ./lepton/lpt-parser/validator.lua:360
elseif tag == "SafeIndex" then -- ./lepton/lpt-parser/validator.lua:361
return traverse_safeindex(env, exp) -- ./lepton/lpt-parser/validator.lua:362
elseif tag == "TableCompr" then -- ./lepton/lpt-parser/validator.lua:363
return traverse_tablecompr(env, exp) -- ./lepton/lpt-parser/validator.lua:364
elseif tag == "MethodStub" or tag == "SafeMethodStub" then -- ./lepton/lpt-parser/validator.lua:365
return traverse_methodstub(env, exp) -- ./lepton/lpt-parser/validator.lua:366
elseif tag:match("Expr$") then -- ./lepton/lpt-parser/validator.lua:367
return traverse_statexpr(env, exp) -- ./lepton/lpt-parser/validator.lua:368
else -- ./lepton/lpt-parser/validator.lua:368
error("expecting an expression, but got a " .. tag) -- ./lepton/lpt-parser/validator.lua:370
end -- ./lepton/lpt-parser/validator.lua:370
end -- ./lepton/lpt-parser/validator.lua:370
traverse_explist = function(env, explist) -- ./lepton/lpt-parser/validator.lua:374
for k, v in ipairs(explist) do -- ./lepton/lpt-parser/validator.lua:375
local status, msg = traverse_exp(env, v) -- ./lepton/lpt-parser/validator.lua:376
if not status then -- ./lepton/lpt-parser/validator.lua:377
return status, msg -- ./lepton/lpt-parser/validator.lua:377
end -- ./lepton/lpt-parser/validator.lua:377
end -- ./lepton/lpt-parser/validator.lua:377
return true -- ./lepton/lpt-parser/validator.lua:379
end -- ./lepton/lpt-parser/validator.lua:379
traverse_stm = function(env, stm) -- ./lepton/lpt-parser/validator.lua:382
local tag = stm["tag"] -- ./lepton/lpt-parser/validator.lua:383
if tag == "Do" then -- ./lepton/lpt-parser/validator.lua:384
return traverse_block(env, stm) -- ./lepton/lpt-parser/validator.lua:385
elseif tag == "Set" then -- ./lepton/lpt-parser/validator.lua:386
return traverse_assignment(env, stm) -- ./lepton/lpt-parser/validator.lua:387
elseif tag == "AppendSet" then -- ./lepton/lpt-parser/validator.lua:388
return traverse_assignment(env, stm) -- ./lepton/lpt-parser/validator.lua:389
elseif tag == "While" then -- ./lepton/lpt-parser/validator.lua:390
return traverse_while(env, stm) -- ./lepton/lpt-parser/validator.lua:391
elseif tag == "Repeat" then -- ./lepton/lpt-parser/validator.lua:392
return traverse_repeat(env, stm) -- ./lepton/lpt-parser/validator.lua:393
elseif tag == "If" then -- ./lepton/lpt-parser/validator.lua:394
return traverse_if(env, stm) -- ./lepton/lpt-parser/validator.lua:395
elseif tag == "Fornum" then -- ./lepton/lpt-parser/validator.lua:396
return traverse_fornum(env, stm) -- ./lepton/lpt-parser/validator.lua:397
elseif tag == "Forin" then -- ./lepton/lpt-parser/validator.lua:398
return traverse_forin(env, stm) -- ./lepton/lpt-parser/validator.lua:399
elseif tag == "Local" or tag == "Let" then -- ./lepton/lpt-parser/validator.lua:401
return traverse_let(env, stm) -- ./lepton/lpt-parser/validator.lua:402
elseif tag == "Localrec" then -- ./lepton/lpt-parser/validator.lua:403
return traverse_letrec(env, stm) -- ./lepton/lpt-parser/validator.lua:404
elseif tag == "Goto" then -- ./lepton/lpt-parser/validator.lua:405
return traverse_goto(env, stm) -- ./lepton/lpt-parser/validator.lua:406
elseif tag == "Label" then -- ./lepton/lpt-parser/validator.lua:407
return traverse_label(env, stm) -- ./lepton/lpt-parser/validator.lua:408
elseif tag == "Return" then -- ./lepton/lpt-parser/validator.lua:409
return traverse_return(env, stm) -- ./lepton/lpt-parser/validator.lua:410
elseif tag == "Break" then -- ./lepton/lpt-parser/validator.lua:411
return traverse_break(env, stm) -- ./lepton/lpt-parser/validator.lua:412
elseif tag == "Call" then -- ./lepton/lpt-parser/validator.lua:413
return traverse_call(env, stm) -- ./lepton/lpt-parser/validator.lua:414
elseif tag == "Continue" then -- ./lepton/lpt-parser/validator.lua:415
return traverse_continue(env, stm) -- ./lepton/lpt-parser/validator.lua:416
elseif tag == "Push" then -- ./lepton/lpt-parser/validator.lua:417
return traverse_push(env, stm) -- ./lepton/lpt-parser/validator.lua:418
elseif tag == "Broadcast" or tag == "BroadcastKV" or tag == "Filter" or tag == "FilterKV" then -- ./lepton/lpt-parser/validator.lua:419
return traverse_call(env, stm) -- ./lepton/lpt-parser/validator.lua:420
else -- ./lepton/lpt-parser/validator.lua:420
error("expecting a statement, but got a " .. tag) -- ./lepton/lpt-parser/validator.lua:422
end -- ./lepton/lpt-parser/validator.lua:422
end -- ./lepton/lpt-parser/validator.lua:422
traverse_block = function(env, block) -- ./lepton/lpt-parser/validator.lua:426
local l = {} -- ./lepton/lpt-parser/validator.lua:427
new_scope(env) -- ./lepton/lpt-parser/validator.lua:428
for k, v in ipairs(block) do -- ./lepton/lpt-parser/validator.lua:429
local status, msg = traverse_stm(env, v) -- ./lepton/lpt-parser/validator.lua:430
if not status then -- ./lepton/lpt-parser/validator.lua:431
return status, msg -- ./lepton/lpt-parser/validator.lua:431
end -- ./lepton/lpt-parser/validator.lua:431
end -- ./lepton/lpt-parser/validator.lua:431
end_scope(env) -- ./lepton/lpt-parser/validator.lua:433
return true -- ./lepton/lpt-parser/validator.lua:434
end -- ./lepton/lpt-parser/validator.lua:434
local function traverse(ast, errorinfo) -- ./lepton/lpt-parser/validator.lua:438
assert(type(ast) == "table") -- ./lepton/lpt-parser/validator.lua:439
assert(type(errorinfo) == "table") -- ./lepton/lpt-parser/validator.lua:440
local env = { -- ./lepton/lpt-parser/validator.lua:441
["errorinfo"] = errorinfo, -- ./lepton/lpt-parser/validator.lua:441
["function"] = {} -- ./lepton/lpt-parser/validator.lua:441
} -- ./lepton/lpt-parser/validator.lua:441
new_function(env) -- ./lepton/lpt-parser/validator.lua:442
set_vararg(env, true) -- ./lepton/lpt-parser/validator.lua:443
local status, msg = traverse_block(env, ast) -- ./lepton/lpt-parser/validator.lua:444
if not status then -- ./lepton/lpt-parser/validator.lua:445
return status, msg -- ./lepton/lpt-parser/validator.lua:445
end -- ./lepton/lpt-parser/validator.lua:445
end_function(env) -- ./lepton/lpt-parser/validator.lua:446
status, msg = verify_pending_gotos(env) -- ./lepton/lpt-parser/validator.lua:447
if not status then -- ./lepton/lpt-parser/validator.lua:448
return status, msg -- ./lepton/lpt-parser/validator.lua:448
end -- ./lepton/lpt-parser/validator.lua:448
return ast -- ./lepton/lpt-parser/validator.lua:449
end -- ./lepton/lpt-parser/validator.lua:449
return { -- ./lepton/lpt-parser/validator.lua:452
["validate"] = traverse, -- ./lepton/lpt-parser/validator.lua:452
["syntaxerror"] = syntaxerror -- ./lepton/lpt-parser/validator.lua:452
} -- ./lepton/lpt-parser/validator.lua:452
end -- ./lepton/lpt-parser/validator.lua:452
local validator = _() or validator -- ./lepton/lpt-parser/validator.lua:456
package["loaded"]["lepton.lpt-parser.validator"] = validator or true -- ./lepton/lpt-parser/validator.lua:457
local function _() -- ./lepton/lpt-parser/validator.lua:460
...
"ErrOArrowFunc", -- ./lepton/lpt-parser/parser.lua:138
"expected '{' after '->'" -- ./lepton/lpt-parser/parser.lua:138
}, -- ./lepton/lpt-parser/parser.lua:138
{ -- ./lepton/lpt-parser/parser.lua:139
"ErrCArrowFunc", -- ./lepton/lpt-parser/parser.lua:139
"expected '}' to close the arrow function" -- ./lepton/lpt-parser/parser.lua:139
}, -- ./lepton/lpt-parser/parser.lua:139
{ -- ./lepton/lpt-parser/parser.lua:140
"ErrParList", -- ./lepton/lpt-parser/parser.lua:140
"expected a variable name or '...' after ','" -- ./lepton/lpt-parser/parser.lua:140
}, -- ./lepton/lpt-parser/parser.lua:140
{ -- ./lepton/lpt-parser/parser.lua:142
"ErrLabel", -- ./lepton/lpt-parser/parser.lua:142
"expected a label name after '::'" -- ./lepton/lpt-parser/parser.lua:142
}, -- ./lepton/lpt-parser/parser.lua:142
{ -- ./lepton/lpt-parser/parser.lua:143
"ErrCloseLabel", -- ./lepton/lpt-parser/parser.lua:143
"expected '::' after the label" -- ./lepton/lpt-parser/parser.lua:143
}, -- ./lepton/lpt-parser/parser.lua:143
{ -- ./lepton/lpt-parser/parser.lua:144
"ErrGoto", -- ./lepton/lpt-parser/parser.lua:144
"expected a label after 'goto'" -- ./lepton/lpt-parser/parser.lua:144
}, -- ./lepton/lpt-parser/parser.lua:144
{ -- ./lepton/lpt-parser/parser.lua:145
"ErrRetList", -- ./lepton/lpt-parser/parser.lua:145
"expected an expression after ',' in the return statement" -- ./lepton/lpt-parser/parser.lua:145
}, -- ./lepton/lpt-parser/parser.lua:145
{ -- ./lepton/lpt-parser/parser.lua:147
"ErrVarList", -- ./lepton/lpt-parser/parser.lua:147
"expected a variable name after ','" -- ./lepton/lpt-parser/parser.lua:147
}, -- ./lepton/lpt-parser/parser.lua:147
{ -- ./lepton/lpt-parser/parser.lua:148
"ErrExprList", -- ./lepton/lpt-parser/parser.lua:148
"expected an expression after ','" -- ./lepton/lpt-parser/parser.lua:148
}, -- ./lepton/lpt-parser/parser.lua:148
{ -- ./lepton/lpt-parser/parser.lua:150
"ErrOParenExpr", -- ./lepton/lpt-parser/parser.lua:150
"expected '(' before the expression" -- ./lepton/lpt-parser/parser.lua:150
}, -- ./lepton/lpt-parser/parser.lua:150
{ -- ./lepton/lpt-parser/parser.lua:151
"ErrCParenExpr", -- ./lepton/lpt-parser/parser.lua:151
"expected ')' after the expression" -- ./lepton/lpt-parser/parser.lua:151
}, -- ./lepton/lpt-parser/parser.lua:151
{ -- ./lepton/lpt-parser/parser.lua:153
"ErrPipeExpr", -- ./lepton/lpt-parser/parser.lua:153
"expected an expression after the pipe operator" -- ./lepton/lpt-parser/parser.lua:153
}, -- ./lepton/lpt-parser/parser.lua:153
{ -- ./lepton/lpt-parser/parser.lua:154
"ErrOrExpr", -- ./lepton/lpt-parser/parser.lua:154
"expected an expression after '||'" -- ./lepton/lpt-parser/parser.lua:154
}, -- ./lepton/lpt-parser/parser.lua:154
{ -- ./lepton/lpt-parser/parser.lua:155
"ErrAndExpr", -- ./lepton/lpt-parser/parser.lua:155
"expected an expression after '&&'" -- ./lepton/lpt-parser/parser.lua:155
}, -- ./lepton/lpt-parser/parser.lua:155
{ -- ./lepton/lpt-parser/parser.lua:156
"ErrRelExpr", -- ./lepton/lpt-parser/parser.lua:156
"expected an expression after the relational operator" -- ./lepton/lpt-parser/parser.lua:156
}, -- ./lepton/lpt-parser/parser.lua:156
{ -- ./lepton/lpt-parser/parser.lua:157
"ErrBOrExpr", -- ./lepton/lpt-parser/parser.lua:157
"expected an expression after '|'" -- ./lepton/lpt-parser/parser.lua:157
}, -- ./lepton/lpt-parser/parser.lua:157
{ -- ./lepton/lpt-parser/parser.lua:158
"ErrBXorExpr", -- ./lepton/lpt-parser/parser.lua:158
"expected an expression after '~'" -- ./lepton/lpt-parser/parser.lua:158
}, -- ./lepton/lpt-parser/parser.lua:158
{ -- ./lepton/lpt-parser/parser.lua:159
"ErrBAndExpr", -- ./lepton/lpt-parser/parser.lua:159
"expected an expression after '&'" -- ./lepton/lpt-parser/parser.lua:159
}, -- ./lepton/lpt-parser/parser.lua:159
{ -- ./lepton/lpt-parser/parser.lua:160
"ErrShiftExpr", -- ./lepton/lpt-parser/parser.lua:160
"expected an expression after the bit shift" -- ./lepton/lpt-parser/parser.lua:160
}, -- ./lepton/lpt-parser/parser.lua:160
{ -- ./lepton/lpt-parser/parser.lua:161
"ErrConcatExpr", -- ./lepton/lpt-parser/parser.lua:161
"expected an expression after '++'" -- ./lepton/lpt-parser/parser.lua:161
}, -- ./lepton/lpt-parser/parser.lua:161
{ -- ./lepton/lpt-parser/parser.lua:162
"ErrTConcatExpr", -- ./lepton/lpt-parser/parser.lua:162
"expected an expression after '+++'" -- ./lepton/lpt-parser/parser.lua:162
}, -- ./lepton/lpt-parser/parser.lua:162
{ -- ./lepton/lpt-parser/parser.lua:163
"ErrAddExpr", -- ./lepton/lpt-parser/parser.lua:163
"expected an expression after the additive operator" -- ./lepton/lpt-parser/parser.lua:163
}, -- ./lepton/lpt-parser/parser.lua:163
{ -- ./lepton/lpt-parser/parser.lua:164
"ErrMulExpr", -- ./lepton/lpt-parser/parser.lua:164
"expected an expression after the multiplicative operator" -- ./lepton/lpt-parser/parser.lua:164
}, -- ./lepton/lpt-parser/parser.lua:164
{ -- ./lepton/lpt-parser/parser.lua:165
"ErrUnaryExpr", -- ./lepton/lpt-parser/parser.lua:165
"expected an expression after the unary operator" -- ./lepton/lpt-parser/parser.lua:165
}, -- ./lepton/lpt-parser/parser.lua:165
{ -- ./lepton/lpt-parser/parser.lua:166
"ErrPowExpr", -- ./lepton/lpt-parser/parser.lua:166
"expected an expression after '^'" -- ./lepton/lpt-parser/parser.lua:166
}, -- ./lepton/lpt-parser/parser.lua:166
{ -- ./lepton/lpt-parser/parser.lua:168
"ErrExprParen", -- ./lepton/lpt-parser/parser.lua:168
"expected an expression after '('" -- ./lepton/lpt-parser/parser.lua:168
}, -- ./lepton/lpt-parser/parser.lua:168
{ -- ./lepton/lpt-parser/parser.lua:169
"ErrCParenExpr", -- ./lepton/lpt-parser/parser.lua:169
"expected ')' to close the expression" -- ./lepton/lpt-parser/parser.lua:169
}, -- ./lepton/lpt-parser/parser.lua:169
{ -- ./lepton/lpt-parser/parser.lua:170
"ErrNameIndex", -- ./lepton/lpt-parser/parser.lua:170
"expected a field name after '.'" -- ./lepton/lpt-parser/parser.lua:170
}, -- ./lepton/lpt-parser/parser.lua:170
{ -- ./lepton/lpt-parser/parser.lua:171
"ErrExprIndex", -- ./lepton/lpt-parser/parser.lua:171
"expected an expression after '['" -- ./lepton/lpt-parser/parser.lua:171
}, -- ./lepton/lpt-parser/parser.lua:171
{ -- ./lepton/lpt-parser/parser.lua:172
"ErrCBracketIndex", -- ./lepton/lpt-parser/parser.lua:172
"expected ']' to close the indexing expression" -- ./lepton/lpt-parser/parser.lua:172
}, -- ./lepton/lpt-parser/parser.lua:172
{ -- ./lepton/lpt-parser/parser.lua:173
"ErrNameMeth", -- ./lepton/lpt-parser/parser.lua:173
"expected a method name after ':'" -- ./lepton/lpt-parser/parser.lua:173
}, -- ./lepton/lpt-parser/parser.lua:173
{ -- ./lepton/lpt-parser/parser.lua:174
"ErrMethArgs", -- ./lepton/lpt-parser/parser.lua:174
"expected some arguments for the method call (or '()')" -- ./lepton/lpt-parser/parser.lua:174
}, -- ./lepton/lpt-parser/parser.lua:174
{ -- ./lepton/lpt-parser/parser.lua:176
"ErrArgList", -- ./lepton/lpt-parser/parser.lua:176
"expected an expression after ',' in the argument list" -- ./lepton/lpt-parser/parser.lua:176
}, -- ./lepton/lpt-parser/parser.lua:176
{ -- ./lepton/lpt-parser/parser.lua:177
"ErrOParenArgs", -- ./lepton/lpt-parser/parser.lua:177
"expected '(' before the argument list" -- ./lepton/lpt-parser/parser.lua:177
}, -- ./lepton/lpt-parser/parser.lua:177
{ -- ./lepton/lpt-parser/parser.lua:178
"ErrCParenArgs", -- ./lepton/lpt-parser/parser.lua:178
"expected ')' to close the argument list" -- ./lepton/lpt-parser/parser.lua:178
}, -- ./lepton/lpt-parser/parser.lua:178
{ -- ./lepton/lpt-parser/parser.lua:180
"ErrCBraceTable", -- ./lepton/lpt-parser/parser.lua:180
"expected '}' to close the table constructor" -- ./lepton/lpt-parser/parser.lua:180
}, -- ./lepton/lpt-parser/parser.lua:180
{ -- ./lepton/lpt-parser/parser.lua:181
"ErrEqField", -- ./lepton/lpt-parser/parser.lua:181
"expected '=' after the table key" -- ./lepton/lpt-parser/parser.lua:181
}, -- ./lepton/lpt-parser/parser.lua:181
{ -- ./lepton/lpt-parser/parser.lua:182
"ErrExprField", -- ./lepton/lpt-parser/parser.lua:182
"expected an expression after '='" -- ./lepton/lpt-parser/parser.lua:182
}, -- ./lepton/lpt-parser/parser.lua:182
{ -- ./lepton/lpt-parser/parser.lua:183
"ErrExprFKey", -- ./lepton/lpt-parser/parser.lua:183
"expected an expression after '[' for the table key" -- ./lepton/lpt-parser/parser.lua:183
}, -- ./lepton/lpt-parser/parser.lua:183
{ -- ./lepton/lpt-parser/parser.lua:184
"ErrCBracketFKey", -- ./lepton/lpt-parser/parser.lua:184
"expected ']' to close the table key" -- ./lepton/lpt-parser/parser.lua:184
}, -- ./lepton/lpt-parser/parser.lua:184
{ -- ./lepton/lpt-parser/parser.lua:186
"ErrCBraceDestructuring", -- ./lepton/lpt-parser/parser.lua:186
"expected '}' to close the destructuring variable list" -- ./lepton/lpt-parser/parser.lua:186
}, -- ./lepton/lpt-parser/parser.lua:186
{ -- ./lepton/lpt-parser/parser.lua:187
"ErrDestructuringEqField", -- ./lepton/lpt-parser/parser.lua:187
"expected '=' after the table key in destructuring variable list" -- ./lepton/lpt-parser/parser.lua:187
}, -- ./lepton/lpt-parser/parser.lua:187
{ -- ./lepton/lpt-parser/parser.lua:188
"ErrDestructuringExprField", -- ./lepton/lpt-parser/parser.lua:188
"expected an identifier after '=' in destructuring variable list" -- ./lepton/lpt-parser/parser.lua:188
}, -- ./lepton/lpt-parser/parser.lua:188
{ -- ./lepton/lpt-parser/parser.lua:190
"ErrCBracketTableCompr", -- ./lepton/lpt-parser/parser.lua:190
"expected ']' to close the table comprehension" -- ./lepton/lpt-parser/parser.lua:190
}, -- ./lepton/lpt-parser/parser.lua:190
{ -- ./lepton/lpt-parser/parser.lua:192
"ErrDigitHex", -- ./lepton/lpt-parser/parser.lua:192
"expected one or more hexadecimal digits after '0x'" -- ./lepton/lpt-parser/parser.lua:192
}, -- ./lepton/lpt-parser/parser.lua:192
{ -- ./lepton/lpt-parser/parser.lua:193
"ErrDigitBin", -- ./lepton/lpt-parser/parser.lua:193
"expected one or more binary digits after '0b'" -- ./lepton/lpt-parser/parser.lua:193
}, -- ./lepton/lpt-parser/parser.lua:193
{ -- ./lepton/lpt-parser/parser.lua:194
"ErrDigitDeci", -- ./lepton/lpt-parser/parser.lua:194
"expected one or more digits after the decimal point" -- ./lepton/lpt-parser/parser.lua:194
}, -- ./lepton/lpt-parser/parser.lua:194
{ -- ./lepton/lpt-parser/parser.lua:195
"ErrDigitExpo", -- ./lepton/lpt-parser/parser.lua:195
"expected one or more digits for the exponent" -- ./lepton/lpt-parser/parser.lua:195
}, -- ./lepton/lpt-parser/parser.lua:195
{ -- ./lepton/lpt-parser/parser.lua:197
"ErrQuote", -- ./lepton/lpt-parser/parser.lua:197
"unclosed string" -- ./lepton/lpt-parser/parser.lua:197
}, -- ./lepton/lpt-parser/parser.lua:197
{ -- ./lepton/lpt-parser/parser.lua:198
"ErrHexEsc", -- ./lepton/lpt-parser/parser.lua:198
"expected exactly two hexadecimal digits after '\\x'" -- ./lepton/lpt-parser/parser.lua:198
}, -- ./lepton/lpt-parser/parser.lua:198
{ -- ./lepton/lpt-parser/parser.lua:199
"ErrOBraceUEsc", -- ./lepton/lpt-parser/parser.lua:199
"expected '{' after '\\u'" -- ./lepton/lpt-parser/parser.lua:199
}, -- ./lepton/lpt-parser/parser.lua:199
{ -- ./lepton/lpt-parser/parser.lua:200
"ErrDigitUEsc", -- ./lepton/lpt-parser/parser.lua:200
"expected one or more hexadecimal digits for the UTF-8 code point" -- ./lepton/lpt-parser/parser.lua:200
}, -- ./lepton/lpt-parser/parser.lua:200
{ -- ./lepton/lpt-parser/parser.lua:201
"ErrCBraceUEsc", -- ./lepton/lpt-parser/parser.lua:201
"expected '}' after the code point" -- ./lepton/lpt-parser/parser.lua:201
}, -- ./lepton/lpt-parser/parser.lua:201
{ -- ./lepton/lpt-parser/parser.lua:202
"ErrEscSeq", -- ./lepton/lpt-parser/parser.lua:202
"invalid escape sequence" -- ./lepton/lpt-parser/parser.lua:202
}, -- ./lepton/lpt-parser/parser.lua:202
{ -- ./lepton/lpt-parser/parser.lua:203
"ErrCloseLStr", -- ./lepton/lpt-parser/parser.lua:203
"unclosed long string" -- ./lepton/lpt-parser/parser.lua:203
}, -- ./lepton/lpt-parser/parser.lua:203
{ -- ./lepton/lpt-parser/parser.lua:205
"ErrUnknownAttribute", -- ./lepton/lpt-parser/parser.lua:205
"unknown variable attribute" -- ./lepton/lpt-parser/parser.lua:205
}, -- ./lepton/lpt-parser/parser.lua:205
{ -- ./lepton/lpt-parser/parser.lua:206
"ErrCBracketAttribute", -- ./lepton/lpt-parser/parser.lua:206
"expected '>' to close the variable attribute" -- ./lepton/lpt-parser/parser.lua:206
} -- ./lepton/lpt-parser/parser.lua:206
} -- ./lepton/lpt-parser/parser.lua:206
local function throw(label) -- ./lepton/lpt-parser/parser.lua:209
label = "Err" .. label -- ./lepton/lpt-parser/parser.lua:210
for i, labelinfo in ipairs(labels) do -- ./lepton/lpt-parser/parser.lua:212
if labelinfo[1] == label then -- ./lepton/lpt-parser/parser.lua:213
return T(i) -- ./lepton/lpt-parser/parser.lua:214
end -- ./lepton/lpt-parser/parser.lua:214
end -- ./lepton/lpt-parser/parser.lua:214
error("Label not found: " .. label) -- ./lepton/lpt-parser/parser.lua:218
end -- ./lepton/lpt-parser/parser.lua:218
local function e(patt, label) -- ./lepton/lpt-parser/parser.lua:221
return patt + throw(label) -- ./lepton/lpt-parser/parser.lua:222
end -- ./lepton/lpt-parser/parser.lua:222
local function dump(t) -- ./lepton/lpt-parser/parser.lua:228
require("lepton.lpt-parser.pp")["dump"](t) -- ./lepton/lpt-parser/parser.lua:229
return t -- ./lepton/lpt-parser/parser.lua:230
end -- ./lepton/lpt-parser/parser.lua:230
local function isAny(item, comparisons) -- ./lepton/lpt-parser/parser.lua:233
for _, v in ipairs(comparisons) do -- ./lepton/lpt-parser/parser.lua:234
if item == v then -- ./lepton/lpt-parser/parser.lua:235
return true -- ./lepton/lpt-parser/parser.lua:235
end -- ./lepton/lpt-parser/parser.lua:235
end -- ./lepton/lpt-parser/parser.lua:235
return false -- ./lepton/lpt-parser/parser.lua:237
end -- ./lepton/lpt-parser/parser.lua:237
local function token(patt) -- ./lepton/lpt-parser/parser.lua:240
return patt * V("Skip") -- ./lepton/lpt-parser/parser.lua:241
end -- ./lepton/lpt-parser/parser.lua:241
local function sym(str) -- ./lepton/lpt-parser/parser.lua:244
return token(P(str)) -- ./lepton/lpt-parser/parser.lua:245
end -- ./lepton/lpt-parser/parser.lua:245
local function kw(str) -- ./lepton/lpt-parser/parser.lua:248
return token(P(str) * - V("IdRest")) -- ./lepton/lpt-parser/parser.lua:249
end -- ./lepton/lpt-parser/parser.lua:249
local function parenAround(expr) -- ./lepton/lpt-parser/parser.lua:252
return sym("(") * expr * sym(")") -- ./lepton/lpt-parser/parser.lua:253
end -- ./lepton/lpt-parser/parser.lua:253
local function tagC(tag, patt) -- ./lepton/lpt-parser/parser.lua:256
return Ct(Cg(Cp(), "pos") * Cg(Cc(tag), "tag") * patt) -- ./lepton/lpt-parser/parser.lua:257
end -- ./lepton/lpt-parser/parser.lua:257
local function unaryOp(op, e) -- ./lepton/lpt-parser/parser.lua:260
return { -- ./lepton/lpt-parser/parser.lua:261
["tag"] = "Op", -- ./lepton/lpt-parser/parser.lua:261
["pos"] = e["pos"], -- ./lepton/lpt-parser/parser.lua:261
[1] = op, -- ./lepton/lpt-parser/parser.lua:261
[2] = e -- ./lepton/lpt-parser/parser.lua:261
} -- ./lepton/lpt-parser/parser.lua:261
end -- ./lepton/lpt-parser/parser.lua:261
local function binaryOp(e1, op, e2) -- ./lepton/lpt-parser/parser.lua:264
if not op then -- ./lepton/lpt-parser/parser.lua:265
return e1 -- ./lepton/lpt-parser/parser.lua:266
else -- ./lepton/lpt-parser/parser.lua:266
return { -- ./lepton/lpt-parser/parser.lua:268
["tag"] = "Op", -- ./lepton/lpt-parser/parser.lua:268
["pos"] = e1["pos"], -- ./lepton/lpt-parser/parser.lua:268
[1] = op, -- ./lepton/lpt-parser/parser.lua:268
[2] = e1, -- ./lepton/lpt-parser/parser.lua:268
[3] = e2 -- ./lepton/lpt-parser/parser.lua:268
} -- ./lepton/lpt-parser/parser.lua:268
end -- ./lepton/lpt-parser/parser.lua:268
end -- ./lepton/lpt-parser/parser.lua:268
local function sepBy(patt, sep, label) -- ./lepton/lpt-parser/parser.lua:272
if label then -- ./lepton/lpt-parser/parser.lua:273
return patt * Cg(sep * e(patt, label)) ^ 0 -- ./lepton/lpt-parser/parser.lua:274
else -- ./lepton/lpt-parser/parser.lua:274
return patt * Cg(sep * patt) ^ 0 -- ./lepton/lpt-parser/parser.lua:276
end -- ./lepton/lpt-parser/parser.lua:276
end -- ./lepton/lpt-parser/parser.lua:276
local function chainOp(patt, sep, label) -- ./lepton/lpt-parser/parser.lua:280
return Cf(sepBy(patt, sep, label), binaryOp) -- ./lepton/lpt-parser/parser.lua:281
end -- ./lepton/lpt-parser/parser.lua:281
local function commaSep(patt, label) -- ./lepton/lpt-parser/parser.lua:284
return sepBy(patt, sym(","), label) -- ./lepton/lpt-parser/parser.lua:285
end -- ./lepton/lpt-parser/parser.lua:285
local function tagDo(block) -- ./lepton/lpt-parser/parser.lua:288
block["tag"] = "Do" -- ./lepton/lpt-parser/parser.lua:289
return block -- ./lepton/lpt-parser/parser.lua:290
end -- ./lepton/lpt-parser/parser.lua:290
local function fixFuncStat(func) -- ./lepton/lpt-parser/parser.lua:293
if func[1]["is_method"] then -- ./lepton/lpt-parser/parser.lua:294
table["insert"](func[2][1], 1, { -- ./lepton/lpt-parser/parser.lua:294
["tag"] = "Id", -- ./lepton/lpt-parser/parser.lua:294
[1] = "self" -- ./lepton/lpt-parser/parser.lua:294
}) -- ./lepton/lpt-parser/parser.lua:294
end -- ./lepton/lpt-parser/parser.lua:294
func[1] = { func[1] } -- ./lepton/lpt-parser/parser.lua:295
func[2] = { func[2] } -- ./lepton/lpt-parser/parser.lua:296
return func -- ./lepton/lpt-parser/parser.lua:297
end -- ./lepton/lpt-parser/parser.lua:297
local function addDots(params, dots) -- ./lepton/lpt-parser/parser.lua:300
if dots then -- ./lepton/lpt-parser/parser.lua:301
table["insert"](params, dots) -- ./lepton/lpt-parser/parser.lua:301
end -- ./lepton/lpt-parser/parser.lua:301
return params -- ./lepton/lpt-parser/parser.lua:302
end -- ./lepton/lpt-parser/parser.lua:302
local function insertIndex(t, index) -- ./lepton/lpt-parser/parser.lua:305
return { -- ./lepton/lpt-parser/parser.lua:306
["tag"] = "Index", -- ./lepton/lpt-parser/parser.lua:306
["pos"] = t["pos"], -- ./lepton/lpt-parser/parser.lua:306
[1] = t, -- ./lepton/lpt-parser/parser.lua:306
[2] = index -- ./lepton/lpt-parser/parser.lua:306
} -- ./lepton/lpt-parser/parser.lua:306
end -- ./lepton/lpt-parser/parser.lua:306
local function markMethod(t, method) -- ./lepton/lpt-parser/parser.lua:309
if method then -- ./lepton/lpt-parser/parser.lua:310
return { -- ./lepton/lpt-parser/parser.lua:311
["tag"] = "Index", -- ./lepton/lpt-parser/parser.lua:311
["pos"] = t["pos"], -- ./lepton/lpt-parser/parser.lua:311
["is_method"] = true, -- ./lepton/lpt-parser/parser.lua:311
[1] = t, -- ./lepton/lpt-parser/parser.lua:311
[2] = method -- ./lepton/lpt-parser/parser.lua:311
...
local function fixLuaKeywords(t) -- ./lepton/lpt-parser/parser.lua:317
local keywords = { -- ./lepton/lpt-parser/parser.lua:318
"and", -- ./lepton/lpt-parser/parser.lua:318
"do", -- ./lepton/lpt-parser/parser.lua:318
"elseif", -- ./lepton/lpt-parser/parser.lua:318
"end", -- ./lepton/lpt-parser/parser.lua:318
"function", -- ./lepton/lpt-parser/parser.lua:318
"in", -- ./lepton/lpt-parser/parser.lua:318
"not", -- ./lepton/lpt-parser/parser.lua:318
"or", -- ./lepton/lpt-parser/parser.lua:318
"then" -- ./lepton/lpt-parser/parser.lua:318
} -- ./lepton/lpt-parser/parser.lua:318
if t["tag"] == "Pair" then -- ./lepton/lpt-parser/parser.lua:319
if isAny(t[1][1], keywords) then -- ./lepton/lpt-parser/parser.lua:320
t[1][1] = "_" .. t[1][1] -- ./lepton/lpt-parser/parser.lua:321
end -- ./lepton/lpt-parser/parser.lua:321
else -- ./lepton/lpt-parser/parser.lua:321
if isAny(t[1], keywords) then -- ./lepton/lpt-parser/parser.lua:324
t[1] = "_" .. t[1] -- ./lepton/lpt-parser/parser.lua:325
end -- ./lepton/lpt-parser/parser.lua:325
end -- ./lepton/lpt-parser/parser.lua:325
return t -- ./lepton/lpt-parser/parser.lua:328
end -- ./lepton/lpt-parser/parser.lua:328
local function makeSuffixedExpr(t1, t2) -- ./lepton/lpt-parser/parser.lua:331
if isAny(t2["tag"], { -- ./lepton/lpt-parser/parser.lua:332
"Call", -- ./lepton/lpt-parser/parser.lua:332
"SafeCall", -- ./lepton/lpt-parser/parser.lua:332
"Broadcast", -- ./lepton/lpt-parser/parser.lua:332
"BroadcastKV", -- ./lepton/lpt-parser/parser.lua:332
"Filter", -- ./lepton/lpt-parser/parser.lua:332
"FilterKV" -- ./lepton/lpt-parser/parser.lua:332
}) then -- ./lepton/lpt-parser/parser.lua:332
local t = { -- ./lepton/lpt-parser/parser.lua:333
["tag"] = t2["tag"], -- ./lepton/lpt-parser/parser.lua:333
["pos"] = t1["pos"], -- ./lepton/lpt-parser/parser.lua:333
[1] = t1 -- ./lepton/lpt-parser/parser.lua:333
} -- ./lepton/lpt-parser/parser.lua:333
for _, v in ipairs(t2) do -- ./lepton/lpt-parser/parser.lua:334
t[# t + 1] = v -- ./lepton/lpt-parser/parser.lua:335
end -- ./lepton/lpt-parser/parser.lua:335
return t -- ./lepton/lpt-parser/parser.lua:337
elseif t2["tag"] == "MethodStub" or t2["tag"] == "SafeMethodStub" then -- ./lepton/lpt-parser/parser.lua:338
return { -- ./lepton/lpt-parser/parser.lua:339
["tag"] = t2["tag"], -- ./lepton/lpt-parser/parser.lua:339
["pos"] = t1["pos"], -- ./lepton/lpt-parser/parser.lua:339
[1] = t1, -- ./lepton/lpt-parser/parser.lua:339
[2] = fixLuaKeywords(t2[1]) -- ./lepton/lpt-parser/parser.lua:339
} -- ./lepton/lpt-parser/parser.lua:339
elseif t2["tag"] == "SafeDotIndex" or t2["tag"] == "SafeArrayIndex" then -- ./lepton/lpt-parser/parser.lua:340
return { -- ./lepton/lpt-parser/parser.lua:341
["tag"] = "SafeIndex", -- ./lepton/lpt-parser/parser.lua:341
["pos"] = t1["pos"], -- ./lepton/lpt-parser/parser.lua:341
[1] = t1, -- ./lepton/lpt-parser/parser.lua:341
[2] = fixLuaKeywords(t2[1]) -- ./lepton/lpt-parser/parser.lua:341
} -- ./lepton/lpt-parser/parser.lua:341
elseif t2["tag"] == "DotIndex" or t2["tag"] == "ArrayIndex" then -- ./lepton/lpt-parser/parser.lua:342
return { -- ./lepton/lpt-parser/parser.lua:343
["tag"] = "Index", -- ./lepton/lpt-parser/parser.lua:343
["pos"] = t1["pos"], -- ./lepton/lpt-parser/parser.lua:343
[1] = t1, -- ./lepton/lpt-parser/parser.lua:343
[2] = fixLuaKeywords(t2[1]) -- ./lepton/lpt-parser/parser.lua:343
} -- ./lepton/lpt-parser/parser.lua:343
else -- ./lepton/lpt-parser/parser.lua:343
error("unexpected tag in suffixed expression") -- ./lepton/lpt-parser/parser.lua:345
end -- ./lepton/lpt-parser/parser.lua:345
end -- ./lepton/lpt-parser/parser.lua:345
local function fixArrowFunc(t) -- ./lepton/lpt-parser/parser.lua:349
if t[1] == ":" then -- ./lepton/lpt-parser/parser.lua:350
table["insert"](t[2], 1, { -- ./lepton/lpt-parser/parser.lua:351
["tag"] = "Id", -- ./lepton/lpt-parser/parser.lua:351
"self" -- ./lepton/lpt-parser/parser.lua:351
}) -- ./lepton/lpt-parser/parser.lua:351
table["remove"](t, 1) -- ./lepton/lpt-parser/parser.lua:352
t["is_method"] = true -- ./lepton/lpt-parser/parser.lua:353
end -- ./lepton/lpt-parser/parser.lua:353
t["is_short"] = true -- ./lepton/lpt-parser/parser.lua:355
return t -- ./lepton/lpt-parser/parser.lua:356
end -- ./lepton/lpt-parser/parser.lua:356
local function markImplicit(t) -- ./lepton/lpt-parser/parser.lua:359
t["implicit"] = true -- ./lepton/lpt-parser/parser.lua:360
return t -- ./lepton/lpt-parser/parser.lua:361
end -- ./lepton/lpt-parser/parser.lua:361
local function statToExpr(t) -- ./lepton/lpt-parser/parser.lua:364
t["tag"] = t["tag"] .. "Expr" -- ./lepton/lpt-parser/parser.lua:365
return t -- ./lepton/lpt-parser/parser.lua:366
end -- ./lepton/lpt-parser/parser.lua:366
local function fixStructure(t) -- ./lepton/lpt-parser/parser.lua:369
local i = 1 -- ./lepton/lpt-parser/parser.lua:370
while i <= # t do -- ./lepton/lpt-parser/parser.lua:371
if type(t[i]) == "table" then -- ./lepton/lpt-parser/parser.lua:372
fixStructure(t[i]) -- ./lepton/lpt-parser/parser.lua:373
for j = # t[i], 1, - 1 do -- ./lepton/lpt-parser/parser.lua:374
local stat = t[i][j] -- ./lepton/lpt-parser/parser.lua:375
if type(stat) == "table" and stat["move_up_block"] and stat["move_up_block"] > 0 then -- ./lepton/lpt-parser/parser.lua:376
table["remove"](t[i], j) -- ./lepton/lpt-parser/parser.lua:377
table["insert"](t, i + 1, stat) -- ./lepton/lpt-parser/parser.lua:378
if t["tag"] == "Block" or t["tag"] == "Do" then -- ./lepton/lpt-parser/parser.lua:379
stat["move_up_block"] = stat["move_up_block"] - 1 -- ./lepton/lpt-parser/parser.lua:380
end -- ./lepton/lpt-parser/parser.lua:380
end -- ./lepton/lpt-parser/parser.lua:380
end -- ./lepton/lpt-parser/parser.lua:380
end -- ./lepton/lpt-parser/parser.lua:380
i = i + 1 -- ./lepton/lpt-parser/parser.lua:385
end -- ./lepton/lpt-parser/parser.lua:385
return t -- ./lepton/lpt-parser/parser.lua:387
end -- ./lepton/lpt-parser/parser.lua:387
local function eStart(label) -- ./lepton/lpt-parser/parser.lua:390
return e(sym("{"), label) -- ./lepton/lpt-parser/parser.lua:391
end -- ./lepton/lpt-parser/parser.lua:391
local function eEnd(label) -- ./lepton/lpt-parser/parser.lua:394
return e(sym("}"), label) -- ./lepton/lpt-parser/parser.lua:395
end -- ./lepton/lpt-parser/parser.lua:395
local function eBlkStartEnd(startLabel, endLabel, canFollow) -- ./lepton/lpt-parser/parser.lua:398
if canFollow then -- ./lepton/lpt-parser/parser.lua:399
return eStart(startLabel) * V("Block") * eEnd(endLabel) * canFollow ^ - 1 -- ./lepton/lpt-parser/parser.lua:400
else -- ./lepton/lpt-parser/parser.lua:400
return eStart(startLabel) * V("Block") * eEnd(endLabel) -- ./lepton/lpt-parser/parser.lua:402
end -- ./lepton/lpt-parser/parser.lua:402
end -- ./lepton/lpt-parser/parser.lua:402
local function eBlkStartEndOrSingleStat(startLabel, endLabel, canFollow) -- ./lepton/lpt-parser/parser.lua:406
local start = sym("{") -- ./lepton/lpt-parser/parser.lua:407
if canFollow then -- ./lepton/lpt-parser/parser.lua:408
return (- start * V("SingleStatBlock") * canFollow ^ - 1) + (eStart(startLabel) * V("Block") * (eEnd(endLabel) * canFollow + eEnd(endLabel))) -- ./lepton/lpt-parser/parser.lua:410
else -- ./lepton/lpt-parser/parser.lua:410
return (- start * V("SingleStatBlock")) + (eStart(startLabel) * V("Block") * eEnd(endLabel)) -- ./lepton/lpt-parser/parser.lua:413
end -- ./lepton/lpt-parser/parser.lua:413
end -- ./lepton/lpt-parser/parser.lua:413
local function mb(patt) -- ./lepton/lpt-parser/parser.lua:417
return # patt / 0 * patt -- ./lepton/lpt-parser/parser.lua:418
end -- ./lepton/lpt-parser/parser.lua:418
local function setAttribute(attribute) -- ./lepton/lpt-parser/parser.lua:421
return function(assign) -- ./lepton/lpt-parser/parser.lua:422
assign[1]["tag"] = "AttributeNameList" -- ./lepton/lpt-parser/parser.lua:423
for _, id in ipairs(assign[1]) do -- ./lepton/lpt-parser/parser.lua:424
if id["tag"] == "Id" then -- ./lepton/lpt-parser/parser.lua:425
id["tag"] = "AttributeId" -- ./lepton/lpt-parser/parser.lua:426
id[2] = attribute -- ./lepton/lpt-parser/parser.lua:427
elseif id["tag"] == "DestructuringId" then -- ./lepton/lpt-parser/parser.lua:428
for _, did in ipairs(id) do -- ./lepton/lpt-parser/parser.lua:429
did["tag"] = "AttributeId" -- ./lepton/lpt-parser/parser.lua:430
did[2] = attribute -- ./lepton/lpt-parser/parser.lua:431
end -- ./lepton/lpt-parser/parser.lua:431
end -- ./lepton/lpt-parser/parser.lua:431
end -- ./lepton/lpt-parser/parser.lua:431
return assign -- ./lepton/lpt-parser/parser.lua:435
end -- ./lepton/lpt-parser/parser.lua:435
end -- ./lepton/lpt-parser/parser.lua:435
local stacks = { ["lexpr"] = {} } -- ./lepton/lpt-parser/parser.lua:440
local function push(f) -- ./lepton/lpt-parser/parser.lua:442
return Cmt(P(""), function() -- ./lepton/lpt-parser/parser.lua:443
table["insert"](stacks[f], true) -- ./lepton/lpt-parser/parser.lua:444
return true -- ./lepton/lpt-parser/parser.lua:445
end) -- ./lepton/lpt-parser/parser.lua:445
end -- ./lepton/lpt-parser/parser.lua:445
local function pop(f) -- ./lepton/lpt-parser/parser.lua:448
return Cmt(P(""), function() -- ./lepton/lpt-parser/parser.lua:449
table["remove"](stacks[f]) -- ./lepton/lpt-parser/parser.lua:450
return true -- ./lepton/lpt-parser/parser.lua:451
end) -- ./lepton/lpt-parser/parser.lua:451
end -- ./lepton/lpt-parser/parser.lua:451
local function when(f) -- ./lepton/lpt-parser/parser.lua:454
return Cmt(P(""), function() -- ./lepton/lpt-parser/parser.lua:455
return # stacks[f] > 0 -- ./lepton/lpt-parser/parser.lua:456
end) -- ./lepton/lpt-parser/parser.lua:456
end -- ./lepton/lpt-parser/parser.lua:456
local function set(f, patt) -- ./lepton/lpt-parser/parser.lua:459
return push(f) * patt * pop(f) -- ./lepton/lpt-parser/parser.lua:460
end -- ./lepton/lpt-parser/parser.lua:460
local G = { -- ./lepton/lpt-parser/parser.lua:465
V("Lua"), -- ./lepton/lpt-parser/parser.lua:465
["Lua"] = (V("Shebang") ^ - 1 * V("Skip") * V("Block") * e(P(- 1), "Extra")) / fixStructure, -- ./lepton/lpt-parser/parser.lua:466
["Shebang"] = P("#!") * (P(1) - P("\
")) ^ 0, -- ./lepton/lpt-parser/parser.lua:467
["Block"] = tagC("Block", (V("Stat") + - V("BlockEnd") * throw("InvalidStat")) ^ 0 * ((V("RetStat") + V("ImplicitPushStat")) * sym(";") ^ - 1) ^ - 1), -- ./lepton/lpt-parser/parser.lua:469
["Stat"] = V("IfStat") + V("DoStat") + V("WhileStat") + V("RepeatStat") + V("ForStat") + V("LocalStat") + V("FuncStat") + V("BreakStat") + V("LabelStat") + V("GoToStat") + V("LetStat") + V("ConstStat") + V("CloseStat") + V("FuncCall") + V("Assignment") + V("AppendAssignment") + V("ContinueStat") + V("PushStat") + sym(";"), -- ./lepton/lpt-parser/parser.lua:475
["BlockEnd"] = P("return") + sym("}") + "]" + - 1 + V("ImplicitPushStat") + V("Assignment"), -- ./lepton/lpt-parser/parser.lua:476
["SingleStatBlock"] = tagC("Block", V("Stat") + V("RetStat") + V("ImplicitPushStat")), -- ./lepton/lpt-parser/parser.lua:478
["BlockNoErr"] = tagC("Block", V("Stat") ^ 0 * ((V("RetStat") + V("ImplicitPushStat")) * sym(";") ^ - 1) ^ - 1), -- ./lepton/lpt-parser/parser.lua:479
["IfStat"] = tagC("If", V("IfPart")), -- ./lepton/lpt-parser/parser.lua:481
["IfPart"] = kw("if") * set("lexpr", e(parenAround(V("Expr")), "ExprIf")) * eBlkStartEndOrSingleStat("OIf", "CIf", V("ElseIfPart") + V("ElsePart")), -- ./lepton/lpt-parser/parser.lua:482
["ElseIfPart"] = kw("else") * V("IfPart"), -- ./lepton/lpt-parser/parser.lua:483
["ElsePart"] = kw("else") * eBlkStartEndOrSingleStat("OElse", "CIf"), -- ./lepton/lpt-parser/parser.lua:484
["DoStat"] = kw("do") * eBlkStartEndOrSingleStat("ODo", "CDo") / tagDo, -- ./lepton/lpt-parser/parser.lua:486
["WhileStat"] = tagC("While", kw("while") * set("lexpr", e(parenAround(V("Expr")), "ExprWhile")) * V("WhileBody")), -- ./lepton/lpt-parser/parser.lua:487
["WhileBody"] = eBlkStartEndOrSingleStat("DoWhile", "EndWhile"), -- ./lepton/lpt-parser/parser.lua:488
["RepeatStat"] = tagC("Repeat", kw("repeat") * eBlkStartEndOrSingleStat("ORep", "CRep") * e(kw("until"), "UntilRep") * e(parenAround(V("Expr")), "ExprRep")), -- ./lepton/lpt-parser/parser.lua:489
["ForStat"] = kw("for") * e(V("ForNum") + V("ForIn"), "ForRange"), -- ./lepton/lpt-parser/parser.lua:491
["ForNum"] = tagC("Fornum", parenAround(V("Id") * sym(":") * V("NumRange")) * V("ForBody")), -- ./lepton/lpt-parser/parser.lua:492
["NumRange"] = e(V("Expr"), "ForRangeStart") * e(sym(","), "ForRangeComma") * e(V("Expr"), "ForRangeEnd") * (sym(":") * e(V("Expr"), "ForRangeStep")) ^ - 1, -- ./lepton/lpt-parser/parser.lua:494
["ForIn"] = tagC("Forin", parenAround(V("DestructuringNameList") * e(sym(":"), "InFor") * e(V("ExprList"), "EListFor")) * V("ForBody")), -- ./lepton/lpt-parser/parser.lua:495
["ForBody"] = eBlkStartEndOrSingleStat("OFor", "CFor"), -- ./lepton/lpt-parser/parser.lua:496
["LocalStat"] = kw("local") * e(V("LocalFunc") + V("LocalAssign"), "DefLocal"), -- ./lepton/lpt-parser/parser.lua:498
["LocalFunc"] = tagC("Localrec", kw("fn") * e(V("Id"), "NameLFunc") * V("FuncBody")) / fixFuncStat, -- ./lepton/lpt-parser/parser.lua:499
["LocalAssign"] = tagC("Local", V("AttributeNameList") * (sym("=") * e(V("ExprList"), "EListLAssign") + Ct(Cc()))) + tagC("Local", V("DestructuringNameList") * sym("=") * e(V("ExprList"), "EListLAssign")), -- ./lepton/lpt-parser/parser.lua:501
["LetStat"] = kw("let") * e(V("LetAssign"), "DefLet"), -- ./lepton/lpt-parser/parser.lua:503
["LetAssign"] = tagC("Let", V("NameList") * (sym("=") * e(V("ExprList"), "EListLAssign") + Ct(Cc()))) + tagC("Let", V("DestructuringNameList") * sym("=") * e(V("ExprList"), "EListLAssign")), -- ./lepton/lpt-parser/parser.lua:505
["ConstStat"] = kw("const") * e(V("AttributeAssign") / setAttribute("const"), "DefConst"), -- ./lepton/lpt-parser/parser.lua:507
["CloseStat"] = kw("close") * e(V("AttributeAssign") / setAttribute("close"), "DefClose"), -- ./lepton/lpt-parser/parser.lua:508
["AttributeAssign"] = tagC("Local", V("NameList") * (sym("=") * e(V("ExprList"), "EListLAssign") + Ct(Cc()))) + tagC("Local", V("DestructuringNameList") * sym("=") * e(V("ExprList"), "EListLAssign")), -- ./lepton/lpt-parser/parser.lua:510
["Assignment"] = tagC("Set", (V("VarList") + V("DestructuringNameList")) * V("BinOp") ^ - 1 * ((P("=") - "==") / "=") * ((V("BinOp") - P("-")) + # (P("-") * V("Space")) * V("BinOp")) ^ - 1 * V("Skip") * e(V("ExprList"), "EListAssign")), -- ./lepton/lpt-parser/parser.lua:513
["AppendAssignment"] = tagC("AppendSet", V("VarList") * sym("#=") * e(V("ExprList"), "EListAssign")), -- ./lepton/lpt-parser/parser.lua:515
["FuncStat"] = tagC("Set", kw("fn") * e(V("FuncName"), "FuncName") * V("FuncBody")) / fixFuncStat, -- ./lepton/lpt-parser/parser.lua:517
["FuncName"] = Cf(V("Id") * (sym(".") * e(V("StrId"), "NameFunc1")) ^ 0, insertIndex) * (sym(":") * e(V("StrId"), "NameFunc2")) ^ - 1 / markMethod, -- ./lepton/lpt-parser/parser.lua:519
["FuncBody"] = tagC("Function", V("FuncParams") * eBlkStartEndOrSingleStat("OFunc", "CFunc")), -- ./lepton/lpt-parser/parser.lua:520
["FuncParams"] = e(sym("("), "OParenPList") * V("ParList") * e(sym(")"), "CParenPList"), -- ./lepton/lpt-parser/parser.lua:521
["ParList"] = V("NamedParList") * (sym(",") * e(tagC("Dots", sym("...")), "ParList")) ^ - 1 / addDots + Ct(tagC("Dots", sym("..."))) + Ct(Cc()), -- ./lepton/lpt-parser/parser.lua:524
["ArrowFuncDef"] = tagC("Function", V("ArrowFuncParams") * sym("->") * V("ArrowFuncBody")) / fixArrowFunc, -- ./lepton/lpt-parser/parser.lua:526
["ArrowFuncParams"] = (sym(":") / ":") ^ - 1 * (parenAround(V("ParList")) + tagC("NamedPar", V("NamedPar"))), -- ./lepton/lpt-parser/parser.lua:527
["ArrowFuncBody"] = (- sym("{") * tagC("Block", tagC("Push", V("OrExpr"))) * - sym("}")) + eBlkStartEnd("OArrowFunc", "CArrowFunc"), -- ./lepton/lpt-parser/parser.lua:528
["NamedParList"] = tagC("NamedParList", commaSep(V("NamedPar"))), -- ./lepton/lpt-parser/parser.lua:530
["NamedPar"] = tagC("ParPair", V("ParKey") * e(sym("="), "EqField") * e(V("Expr"), "ExprField")) + V("Id"), -- ./lepton/lpt-parser/parser.lua:531
["ParKey"] = V("Id") * # ("=" * - P("=")), -- ./lepton/lpt-parser/parser.lua:532
["LabelStat"] = tagC("Label", sym("::") * e(V("Name"), "Label") * e(sym("::"), "CloseLabel")), -- ./lepton/lpt-parser/parser.lua:534
["GoToStat"] = tagC("Goto", kw("goto") * e(V("Name"), "Goto")), -- ./lepton/lpt-parser/parser.lua:535
["BreakStat"] = tagC("Break", kw("break")), -- ./lepton/lpt-parser/parser.lua:536
["ContinueStat"] = tagC("Continue", kw("continue")), -- ./lepton/lpt-parser/parser.lua:537
["RetStat"] = tagC("Return", kw("return") * commaSep(V("Expr"), "RetList") ^ - 1), -- ./lepton/lpt-parser/parser.lua:538
["PushStat"] = tagC("Push", kw("push") * commaSep(V("Expr"), "RetList") ^ - 1), -- ./lepton/lpt-parser/parser.lua:540
["ImplicitPushStat"] = tagC("Push", commaSep(V("Expr"), "RetList")) / markImplicit, -- ./lepton/lpt-parser/parser.lua:541
["NameList"] = tagC("NameList", commaSep(V("Id"))), -- ./lepton/lpt-parser/parser.lua:543
["DestructuringNameList"] = tagC("NameList", commaSep(V("DestructuringId"))), -- ./lepton/lpt-parser/parser.lua:544
["AttributeNameList"] = tagC("AttributeNameList", commaSep(V("AttributeId"))), -- ./lepton/lpt-parser/parser.lua:545
["VarList"] = tagC("VarList", commaSep(V("VarExpr"))), -- ./lepton/lpt-parser/parser.lua:546
["ExprList"] = tagC("ExpList", commaSep(V("Expr"), "ExprList")), -- ./lepton/lpt-parser/parser.lua:547
["DestructuringId"] = tagC("DestructuringId", sym("{") * V("DestructuringIdFieldList") * e(sym("}"), "CBraceDestructuring")) + V("Id"), -- ./lepton/lpt-parser/parser.lua:549
["DestructuringIdFieldList"] = sepBy(V("DestructuringIdField"), V("FieldSep")) * V("FieldSep") ^ - 1, -- ./lepton/lpt-parser/parser.lua:550
["DestructuringIdField"] = tagC("Pair", V("FieldKey") * e(sym("="), "DestructuringEqField") * e(V("Id"), "DestructuringExprField")) + V("Id"), -- ./lepton/lpt-parser/parser.lua:551
["Expr"] = V("PipeExpr"), -- ./lepton/lpt-parser/parser.lua:553
["PipeExpr"] = chainOp(V("OrExpr"), V("PipeOp"), "PipeExpr"), -- ./lepton/lpt-parser/parser.lua:554
["OrExpr"] = chainOp(V("AndExpr"), V("OrOp"), "OrExpr"), -- ./lepton/lpt-parser/parser.lua:555
["AndExpr"] = chainOp(V("RelExpr"), V("AndOp"), "AndExpr"), -- ./lepton/lpt-parser/parser.lua:556
["RelExpr"] = chainOp(V("BOrExpr"), V("RelOp"), "RelExpr"), -- ./lepton/lpt-parser/parser.lua:557
["BOrExpr"] = chainOp(V("BXorExpr"), V("BOrOp"), "BOrExpr"), -- ./lepton/lpt-parser/parser.lua:558
["BXorExpr"] = chainOp(V("BAndExpr"), V("BXorOp"), "BXorExpr"), -- ./lepton/lpt-parser/parser.lua:559
["BAndExpr"] = chainOp(V("ShiftExpr"), V("BAndOp"), "BAndExpr"), -- ./lepton/lpt-parser/parser.lua:560
["ShiftExpr"] = chainOp(V("ConcatExpr"), V("ShiftOp"), "ShiftExpr"), -- ./lepton/lpt-parser/parser.lua:561
["ConcatExpr"] = V("TConcatExpr") * (V("ConcatOp") * e(V("ConcatExpr"), "ConcatExpr")) ^ - 1 / binaryOp, -- ./lepton/lpt-parser/parser.lua:562
["TConcatExpr"] = V("AddExpr") * (V("TConcatOp") * e(V("TConcatExpr"), "TConcatExpr")) ^ - 1 / binaryOp, -- ./lepton/lpt-parser/parser.lua:563
["AddExpr"] = chainOp(V("MulExpr"), V("AddOp"), "AddExpr"), -- ./lepton/lpt-parser/parser.lua:564
["MulExpr"] = chainOp(V("UnaryExpr"), V("MulOp"), "MulExpr"), -- ./lepton/lpt-parser/parser.lua:565
["UnaryExpr"] = V("UnaryOp") * e(V("UnaryExpr"), "UnaryExpr") / unaryOp + V("PowExpr"), -- ./lepton/lpt-parser/parser.lua:567
["PowExpr"] = V("SimpleExpr") * (V("PowOp") * e(V("UnaryExpr"), "PowExpr")) ^ - 1 / binaryOp, -- ./lepton/lpt-parser/parser.lua:568
["SimpleExpr"] = tagC("Number", V("Number")) + tagC("Nil", kw("nil")) + tagC("Boolean", kw("false") * Cc(false)) + tagC("Boolean", kw("true") * Cc(true)) + tagC("Dots", sym("...")) + V("FuncDef") + V("ArrowFuncDef") + (when("lexpr") * tagC("LetExpr", mb(V("DestructuringNameList")) * sym("=") * - sym("=") * e(V("ExprList"), "EListLAssign"))) + V("SuffixedExpr") + V("StatExpr"), -- ./lepton/lpt-parser/parser.lua:578
["StatExpr"] = (V("IfStat") + V("DoStat") + V("WhileStat") + V("RepeatStat") + V("ForStat")) / statToExpr, -- ./lepton/lpt-parser/parser.lua:580
["FuncCall"] = Cmt(V("SuffixedExpr"), function(s, i, exp) -- ./lepton/lpt-parser/parser.lua:582
return exp["tag"] == "Call" or exp["tag"] == "SafeCall" or exp["tag"] == "Broadcast" or exp["tag"] == "BroadcastKV" or exp["tag"] == "Filter" or exp["tag"] == "FilterKV", exp -- ./lepton/lpt-parser/parser.lua:590
end), -- ./lepton/lpt-parser/parser.lua:590
["VarExpr"] = Cmt(V("SuffixedExpr"), function(s, i, exp) -- ./lepton/lpt-parser/parser.lua:592
return exp["tag"] == "Id" or exp["tag"] == "Index", exp -- ./lepton/lpt-parser/parser.lua:592
end), -- ./lepton/lpt-parser/parser.lua:592
["SuffixedExpr"] = Cf(V("PrimaryExpr") * (V("Index") + V("MethodStub") + V("Call")) ^ 0 + V("NoCallPrimaryExpr") * - V("Call") * (V("Index") + V("MethodStub") + V("Call")) ^ 0 + V("NoCallPrimaryExpr"), makeSuffixedExpr), -- ./lepton/lpt-parser/parser.lua:596
["PrimaryExpr"] = V("SelfId") * (V("SelfCall") + V("SelfIndex")) + V("Id") + tagC("Paren", sym("(") * e(V("Expr"), "ExprParen") * e(sym(")"), "CParenExpr")) + V("StringFormat"), -- ./lepton/lpt-parser/parser.lua:600
["NoCallPrimaryExpr"] = tagC("String", V("String")) + V("Table") + V("TableCompr"), -- ./lepton/lpt-parser/parser.lua:601
["Index"] = tagC("DotIndex", sym("." * - P(".") * - V("Call") * - V("PipeOp")) * e(V("StrId"), "NameIndex")) + tagC("ArrayIndex", sym("[" * - P(S("=["))) * e(V("Expr"), "ExprIndex") * e(sym("]"), "CBracketIndex")) + tagC("SafeDotIndex", sym("?." * - P(".")) * e(V("StrId"), "NameIndex")) + tagC("SafeArrayIndex", sym("?[" * - P(S("=["))) * e(V("Expr"), "ExprIndex") * e(sym("]"), "CBracketIndex")), -- ./lepton/lpt-parser/parser.lua:605
["MethodStub"] = tagC("MethodStub", sym(":" * - P(":")) * e(V("StrId"), "NameMeth")) + tagC("SafeMethodStub", sym("?:" * - P(":")) * e(V("StrId"), "NameMeth")), -- ./lepton/lpt-parser/parser.lua:607
["Call"] = tagC("Call", V("FuncArgs")) + tagC("SafeCall", sym("?") * V("FuncArgs")) + tagC("Broadcast", sym(".") * V("FuncArgs")) + tagC("BroadcastKV", sym("..") * V("FuncArgs")) + tagC("Filter", sym("-<") * V("FuncArgs")) + tagC("FilterKV", sym("-<<") * V("FuncArgs")), -- ./lepton/lpt-parser/parser.lua:613
["SelfCall"] = tagC("MethodStub", V("StrId")) * V("Call"), -- ./lepton/lpt-parser/parser.lua:614
["SelfIndex"] = tagC("DotIndex", V("StrId")), -- ./lepton/lpt-parser/parser.lua:615
["FuncDef"] = (kw("fn") * V("FuncBody")), -- ./lepton/lpt-parser/parser.lua:617
["FuncArgs"] = sym("(") * commaSep(V("Expr"), "ArgList") ^ - 1 * e(sym(")"), "CParenArgs"), -- ./lepton/lpt-parser/parser.lua:618
["Table"] = tagC("Table", sym("{") * V("FieldList") ^ - 1 * e(sym("}"), "CBraceTable")), -- ./lepton/lpt-parser/parser.lua:620
["FieldList"] = sepBy(V("Field"), V("FieldSep")) * V("FieldSep") ^ - 1, -- ./lepton/lpt-parser/parser.lua:621
["Field"] = tagC("Pair", V("FieldKey") * e(sym("="), "EqField") * e(V("Expr"), "ExprField")) / fixLuaKeywords + V("Expr"), -- ./lepton/lpt-parser/parser.lua:623
["FieldKey"] = sym("[" * - P(S("=["))) * e(V("Expr"), "ExprFKey") * e(sym("]"), "CBracketFKey") + V("StrId") * # ("=" * - P("=")), -- ./lepton/lpt-parser/parser.lua:625
["FieldSep"] = sym(",") + sym(";"), -- ./lepton/lpt-parser/parser.lua:626
["TableCompr"] = tagC("TableCompr", sym("[") * V("Block") * e(sym("]"), "CBracketTableCompr")), -- ./lepton/lpt-parser/parser.lua:628
["SelfId"] = tagC("Id", sym("@") / "self"), -- ./lepton/lpt-parser/parser.lua:630
["Id"] = (tagC("Id", V("Name")) / fixLuaKeywords) + V("SelfId"), -- ./lepton/lpt-parser/parser.lua:631
["AttributeSelfId"] = tagC("AttributeId", sym("@") / "self" * V("Attribute") ^ - 1), -- ./lepton/lpt-parser/parser.lua:632
["AttributeId"] = tagC("AttributeId", V("Name") * V("Attribute") ^ - 1) / fixLuaKeywords + V("AttributeSelfId"), -- ./lepton/lpt-parser/parser.lua:633
["StrId"] = tagC("String", V("Name")), -- ./lepton/lpt-parser/parser.lua:634
["Attribute"] = sym("<") * e(kw("const") / "const" + kw("close") / "close", "UnknownAttribute") * e(sym(">"), "CBracketAttribute"), -- ./lepton/lpt-parser/parser.lua:636
["Skip"] = (V("Space") + V("Comment")) ^ 0, -- ./lepton/lpt-parser/parser.lua:639
["Space"] = space ^ 1, -- ./lepton/lpt-parser/parser.lua:640
["Comment"] = P("--") * V("LongStr") / 0 + P("--") * (P(1) - P("\
")) ^ 0, -- ./lepton/lpt-parser/parser.lua:642
["Name"] = token(- V("Reserved") * C(V("Ident"))), -- ./lepton/lpt-parser/parser.lua:644
["Reserved"] = V("Keywords") * - V("IdRest"), -- ./lepton/lpt-parser/parser.lua:645
["Keywords"] = P("close") + "const" + "fn" + "global" + "let" + "push" + "break" + "else" + "false" + "for" + "goto" + "if" + "local" + "nil" + "repeat" + "return" + "true" + "until" + "while", -- ./lepton/lpt-parser/parser.lua:650
["Ident"] = V("IdStart") * V("IdRest") ^ 0, -- ./lepton/lpt-parser/parser.lua:651
["IdStart"] = alpha + P("_"), -- ./lepton/lpt-parser/parser.lua:652
["IdRest"] = alnum + P("_"), -- ./lepton/lpt-parser/parser.lua:653
["Number"] = token(C(V("Hex") + V("Bin") + V("Float") + V("Int"))), -- ./lepton/lpt-parser/parser.lua:655
["Hex"] = (P("0x") + "0X") * ((xdigit ^ 0 * V("DeciHex")) + (e(xdigit ^ 1, "DigitHex") * V("DeciHex") ^ - 1)) * V("ExpoHex") ^ - 1, -- ./lepton/lpt-parser/parser.lua:656
["Bin"] = (P("0b") + "0B") * ((S("_01") ^ 0 * V("DeciBin")) + (e(S("_01") ^ 1, "DigitBin") * V("DeciBin") ^ - 1)), -- ./lepton/lpt-parser/parser.lua:657
["Float"] = V("Decimal") * V("Expo") ^ - 1 + V("Int") * V("Expo"), -- ./lepton/lpt-parser/parser.lua:659
["Decimal"] = digit ^ 1 * "." * digit ^ 0 + P(".") * - P(".") * e(digit ^ 1, "DigitDeci"), -- ./lepton/lpt-parser/parser.lua:661
["DeciHex"] = P(".") * xdigit ^ 0, -- ./lepton/lpt-parser/parser.lua:662
["DeciBin"] = P(".") * S("_01") ^ 0, -- ./lepton/lpt-parser/parser.lua:663
["Expo"] = S("eE") * S("+-") ^ - 1 * e(digit ^ 1, "DigitExpo"), -- ./lepton/lpt-parser/parser.lua:664
["ExpoHex"] = S("pP") * S("+-") ^ - 1 * e(xdigit ^ 1, "DigitExpo"), -- ./lepton/lpt-parser/parser.lua:665
["Int"] = digit ^ 1, -- ./lepton/lpt-parser/parser.lua:666
["StringFormat"] = tagC("StringFormat", V("String") * V("Call")), -- ./lepton/lpt-parser/parser.lua:668
["String"] = token(V("ShortStr") + V("LongStr")), -- ./lepton/lpt-parser/parser.lua:669
["ShortStr"] = P("\"") * Cs((V("EscSeq") + (P(1) - S("\"\
"))) ^ 0) * e(P("\""), "Quote") + P("'") * Cs((V("EscSeq") + (P(1) - S("'\
"))) ^ 0) * e(P("'"), "Quote"), -- ./lepton/lpt-parser/parser.lua:671
["EscSeq"] = P("\\") / "" * (P("a") / "\7" + P("b") / "\8" + P("f") / "\12" + P("n") / "\
" + P("r") / "\13" + P("t") / "\9" + P("v") / "\11" + P("\
") / "\
" + P("\13") / "\
" + P("\\") / "\\" + P("\"") / "\"" + P("'") / "'" + P("z") * space ^ 0 / "" + digit * digit ^ - 2 / tonumber / string["char"] + P("x") * e(C(xdigit * xdigit), "HexEsc") * Cc(16) / tonumber / string["char"] + P("u") * e("{", "OBraceUEsc") * e(C(xdigit ^ 1), "DigitUEsc") * Cc(16) * e("}", "CBraceUEsc") / tonumber / (utf8 and utf8["char"] or string["char"]) + throw("EscSeq")), -- ./lepton/lpt-parser/parser.lua:701
["LongStr"] = V("Open") * C((P(1) - V("CloseEq")) ^ 0) * e(V("Close"), "CloseLStr") / function(s, eqs) -- ./lepton/lpt-parser/parser.lua:704
return s -- ./lepton/lpt-parser/parser.lua:704
end, -- ./lepton/lpt-parser/parser.lua:704
["Open"] = "[" * Cg(V("Equals"), "openEq") * "[" * P("\
") ^ - 1, -- ./lepton/lpt-parser/parser.lua:705
["Close"] = "]" * C(V("Equals")) * "]", -- ./lepton/lpt-parser/parser.lua:706
["Equals"] = P("=") ^ 0, -- ./lepton/lpt-parser/parser.lua:707
["CloseEq"] = Cmt(V("Close") * Cb("openEq"), function(s, i, closeEq, openEq) -- ./lepton/lpt-parser/parser.lua:708
return # openEq == # closeEq -- ./lepton/lpt-parser/parser.lua:708
end), -- ./lepton/lpt-parser/parser.lua:708
["PipeOp"] = sym("|>") / "pipe" + sym(".|>") / "pipebc" + sym("..|>") / "pipebckv", -- ./lepton/lpt-parser/parser.lua:712
["OrOp"] = sym("||") / "or", -- ./lepton/lpt-parser/parser.lua:716
["AndOp"] = sym("&&") / "and", -- ./lepton/lpt-parser/parser.lua:717
["RelOp"] = sym("!=") / "ne" + sym("==") / "eq" + sym("<=") / "le" + sym(">=") / "ge" + sym("<") / "lt" + sym(">") / "gt" + sym("%%") / "divb" + sym("!%") / "ndivb", -- ./lepton/lpt-parser/parser.lua:725
["BOrOp"] = sym("|" - P("||") - P("|>")) / "bor", -- ./lepton/lpt-parser/parser.lua:726
["BXorOp"] = sym("~") / "bxor", -- ./lepton/lpt-parser/parser.lua:727
["BAndOp"] = sym("&" - P("&&")) / "band", -- ./lepton/lpt-parser/parser.lua:728
["ShiftOp"] = sym("<<") / "shl" + sym(">>") / "shr", -- ./lepton/lpt-parser/parser.lua:730
["ConcatOp"] = sym("++") / "concat", -- ./lepton/lpt-parser/parser.lua:731
["TConcatOp"] = sym("+++") / "tconcat", -- ./lepton/lpt-parser/parser.lua:732
["AddOp"] = sym("+" - P("++")) / "add" + sym("-" - P("->") - P("-<")) / "sub", -- ./lepton/lpt-parser/parser.lua:734
["AppendOp"] = sym("#=") / "tappend", -- ./lepton/lpt-parser/parser.lua:735
["MulOp"] = sym("*") / "mul" + sym("//") / "idiv" + sym("/") / "div" + sym("%" - P("%%")) / "mod", -- ./lepton/lpt-parser/parser.lua:739
["UnaryOp"] = sym("!") / "not" + sym("-") / "unm" + sym("#") / "len" + sym("~") / "bnot", -- ./lepton/lpt-parser/parser.lua:743
["PowOp"] = sym("^") / "pow", -- ./lepton/lpt-parser/parser.lua:744
["BinOp"] = V("PipeOp") + V("OrOp") + V("AndOp") + V("BOrOp") + V("BXorOp") + V("BAndOp") + V("ShiftOp") + V("ConcatOp") + V("TConcatOp") + V("AddOp") + V("MulOp") + V("PowOp") -- ./lepton/lpt-parser/parser.lua:745
} -- ./lepton/lpt-parser/parser.lua:745
local macroidentifier = { -- ./lepton/lpt-parser/parser.lua:750
e(V("MacroIdentifier"), "InvalidStat") * e(P(- 1), "Extra"), -- ./lepton/lpt-parser/parser.lua:751
["MacroIdentifier"] = tagC("MacroFunction", V("Id") * sym("(") * V("MacroFunctionArgs") * e(sym(")"), "CParenPList")) + V("Id"), -- ./lepton/lpt-parser/parser.lua:754
["MacroFunctionArgs"] = V("NameList") * (sym(",") * e(tagC("Dots", sym("...")), "ParList")) ^ - 1 / addDots + Ct(tagC("Dots", sym("..."))) + Ct(Cc()) -- ./lepton/lpt-parser/parser.lua:758
} -- ./lepton/lpt-parser/parser.lua:758
for k, v in pairs(G) do -- ./lepton/lpt-parser/parser.lua:762
if macroidentifier[k] == nil then -- ./lepton/lpt-parser/parser.lua:763
macroidentifier[k] = v -- ./lepton/lpt-parser/parser.lua:764
end -- ./lepton/lpt-parser/parser.lua:764
end -- ./lepton/lpt-parser/parser.lua:764
local parser = {} -- ./lepton/lpt-parser/parser.lua:770
local validator = require("lepton.lpt-parser.validator") -- ./lepton/lpt-parser/parser.lua:772
local validate = validator["validate"] -- ./lepton/lpt-parser/parser.lua:773
local syntaxerror = validator["syntaxerror"] -- ./lepton/lpt-parser/parser.lua:774
parser["parse"] = function(subject, filename) -- ./lepton/lpt-parser/parser.lua:776
local errorinfo = { -- ./lepton/lpt-parser/parser.lua:777
["subject"] = subject, -- ./lepton/lpt-parser/parser.lua:777
["filename"] = filename -- ./lepton/lpt-parser/parser.lua:777
} -- ./lepton/lpt-parser/parser.lua:777
lpeg["setmaxstack"](1000) -- ./lepton/lpt-parser/parser.lua:778
local ast, label, errpos = lpeg["match"](G, subject, nil, errorinfo) -- ./lepton/lpt-parser/parser.lua:779
if not ast then -- ./lepton/lpt-parser/parser.lua:780
local errmsg = labels[label][2] -- ./lepton/lpt-parser/parser.lua:781
return ast, syntaxerror(errorinfo, errpos, errmsg) -- ./lepton/lpt-parser/parser.lua:782
end -- ./lepton/lpt-parser/parser.lua:782
return validate(ast, errorinfo) -- ./lepton/lpt-parser/parser.lua:784
end -- ./lepton/lpt-parser/parser.lua:784
parser["parsemacroidentifier"] = function(subject, filename) -- ./lepton/lpt-parser/parser.lua:787
local errorinfo = { -- ./lepton/lpt-parser/parser.lua:788
["subject"] = subject, -- ./lepton/lpt-parser/parser.lua:788
["filename"] = filename -- ./lepton/lpt-parser/parser.lua:788
} -- ./lepton/lpt-parser/parser.lua:788
lpeg["setmaxstack"](1000) -- ./lepton/lpt-parser/parser.lua:789
local ast, label, errpos = lpeg["match"](macroidentifier, subject, nil, errorinfo) -- ./lepton/lpt-parser/parser.lua:790
if not ast then -- ./lepton/lpt-parser/parser.lua:791
local errmsg = labels[label][2] -- ./lepton/lpt-parser/parser.lua:792
return ast, syntaxerror(errorinfo, errpos, errmsg) -- ./lepton/lpt-parser/parser.lua:793
end -- ./lepton/lpt-parser/parser.lua:793
return ast -- ./lepton/lpt-parser/parser.lua:795
end -- ./lepton/lpt-parser/parser.lua:795
return parser -- ./lepton/lpt-parser/parser.lua:798
end -- ./lepton/lpt-parser/parser.lua:798
local parser = _() or parser -- ./lepton/lpt-parser/parser.lua:803
package["loaded"]["lepton.lpt-parser.parser"] = parser or true -- ./lepton/lpt-parser/parser.lua:804
